...
from googlecloudsdk.generated_clients.apis.accesscontextmanager.v1 import accesscontextmanager_v1_messages as messages
...
class AccesscontextmanagerV1(base_api.BaseApiClient):
  ...
  class AccessPoliciesAccessLevelsService(base_api.BaseApiService):
    ...
    TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/accessPolicies/{accessPoliciesId}/accessLevels/{accessLevelsId}:testIamPermissions',
        http_method='POST',
  ...
  class AccessPoliciesAuthorizedOrgsDescsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(AccesscontextmanagerV1.AccessPoliciesAuthorizedOrgsDescsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/accessPolicies/{accessPoliciesId}/authorizedOrgsDescs',
        http_method='POST',
        method_id='accesscontextmanager.accessPolicies.authorizedOrgsDescs.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1/{+parent}/authorizedOrgsDescs',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/accessPolicies/{accessPoliciesId}/authorizedOrgsDescs/{authorizedOrgsDescsId}',
        http_method='DELETE',
  ...
  class AccessPoliciesServicePerimetersService(base_api.BaseApiService):
    ...
    TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/accessPolicies/{accessPoliciesId}/servicePerimeters/{servicePerimetersId}:testIamPermissions',
        http_method='POST',
  ...
  class AccessPoliciesService(base_api.BaseApiService):
    ...
    GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/accessPolicies/{accessPoliciesId}:getIamPolicy',
        http_method='POST',
    ...
    SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/accessPolicies/{accessPoliciesId}:setIamPolicy',
        http_method='POST',
    ...
    TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/accessPolicies/{accessPoliciesId}:testIamPermissions',
        http_method='POST',
  ...
  class ServicesService(base_api.BaseApiService):
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['name'],
        query_params=[],
        relative_path='v1/services/{name}',
        request_field='',
