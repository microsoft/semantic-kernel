"""Generated client library for artifactregistry version v1beta2."""
# NOTE: This file is autogenerated and should not be edited by hand.

from __future__ import absolute_import

from apitools.base.py import base_api
from googlecloudsdk.generated_clients.apis.artifactregistry.v1beta2 import artifactregistry_v1beta2_messages as messages


class ArtifactregistryV1beta2(base_api.BaseApiClient):
  """Generated client library for service artifactregistry version v1beta2."""
  ...
  _CLIENT_CLASS_NAME = 'ArtifactregistryV1beta2'
  ...
  def __init__(self, url='', credentials=None,
    ...
    super(ArtifactregistryV1beta2, self).__init__(
  ...
  class ProjectsLocationsOperationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ArtifactregistryV1beta2.ProjectsLocationsOperationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsLocationsRepositoriesFilesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ArtifactregistryV1beta2.ProjectsLocationsRepositoriesFilesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta2/projects/{projectsId}/locations/{locationsId}/repositories/{repositoriesId}/files/{filesId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta2/projects/{projectsId}/locations/{locationsId}/repositories/{repositoriesId}/files',
        http_method='GET',
        method_id='artifactregistry.projects.locations.repositories.files.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'pageSize', 'pageToken'],
        relative_path='v1beta2/{+parent}/files',
        request_field='',
  ...
  class ProjectsLocationsRepositoriesPackagesTagsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ArtifactregistryV1beta2.ProjectsLocationsRepositoriesPackagesTagsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta2/projects/{projectsId}/locations/{locationsId}/repositories/{repositoriesId}/packages/{packagesId}/tags',
        http_method='POST',
        method_id='artifactregistry.projects.locations.repositories.packages.tags.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['tagId'],
        relative_path='v1beta2/{+parent}/tags',
        request_field='tag',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta2/projects/{projectsId}/locations/{locationsId}/repositories/{repositoriesId}/packages/{packagesId}/tags/{tagsId}',
        http_method='DELETE',
  ...
  class ProjectsLocationsRepositoriesPackagesVersionsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ArtifactregistryV1beta2.ProjectsLocationsRepositoriesPackagesVersionsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta2/projects/{projectsId}/locations/{locationsId}/repositories/{repositoriesId}/packages/{packagesId}/versions/{versionsId}',
        http_method='DELETE',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta2/projects/{projectsId}/locations/{locationsId}/repositories/{repositoriesId}/packages/{packagesId}/versions',
        http_method='GET',
        ...
        relative_path='v1beta2/{+parent}/versions',
        request_field='',
  ...
  class ProjectsLocationsRepositoriesPackagesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ArtifactregistryV1beta2.ProjectsLocationsRepositoriesPackagesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta2/projects/{projectsId}/locations/{locationsId}/repositories/{repositoriesId}/packages',
        http_method='GET',
        method_id='artifactregistry.projects.locations.repositories.packages.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['pageSize', 'pageToken'],
        relative_path='v1beta2/{+parent}/packages',
        request_field='',
  ...
  class ProjectsLocationsRepositoriesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ArtifactregistryV1beta2.ProjectsLocationsRepositoriesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta2/projects/{projectsId}/locations/{locationsId}/repositories',
        http_method='POST',
        method_id='artifactregistry.projects.locations.repositories.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['repositoryId'],
        relative_path='v1beta2/{+parent}/repositories',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta2/projects/{projectsId}/locations/{locationsId}/repositories/{repositoriesId}',
        http_method='DELETE',
    ...
    GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta2/projects/{projectsId}/locations/{locationsId}/repositories/{repositoriesId}:getIamPolicy',
        http_method='GET',
    ...
    SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta2/projects/{projectsId}/locations/{locationsId}/repositories/{repositoriesId}:setIamPolicy',
        http_method='POST',
    ...
    TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta2/projects/{projectsId}/locations/{locationsId}/repositories/{repositoriesId}:testIamPermissions',
        http_method='POST',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ArtifactregistryV1beta2.ProjectsLocationsService, self).__init__(client)
      self._upload_configs = {
          }
