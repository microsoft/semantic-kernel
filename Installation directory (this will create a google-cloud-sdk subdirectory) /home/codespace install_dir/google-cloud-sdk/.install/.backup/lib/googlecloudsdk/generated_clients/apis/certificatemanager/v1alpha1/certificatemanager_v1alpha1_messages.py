"""Generated message classes for certificatemanager version v1alpha1.
...
class Certificate(_messages.Message):
  ...
  selfManagedCertData = _messages.MessageField('SelfManagedCertData', 7)
  subjectAlternativeNames = _messages.StringField(8, repeated=True)
...
class GclbTarget(_messages.Message):
  ...
  targetProxy = _messages.StringField(2)
