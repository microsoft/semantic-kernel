"""Generated client library for cloudfunctions version v2beta."""
...
class CloudfunctionsV2beta(base_api.BaseApiClient):
  ...
  class ProjectsLocationsFunctionsService(base_api.BaseApiService):
    ...
    SetupFunctionUpgradeConfig.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2beta/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:setupFunctionUpgradeConfig',
        http_method='POST',
        method_id='cloudfunctions.projects.locations.functions.setupFunctionUpgradeConfig',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v2beta/{+name}:setupFunctionUpgradeConfig',
