...
class ContainerV1(base_api.BaseApiClient):
  ...
  _CLIENT_CLASS_NAME = 'ContainerV1'
  _URL_VERSION = 'v1'
  _API_KEY = None
  ...
  class ProjectsAggregatedUsableSubnetworksService(base_api.BaseApiService):
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/aggregated/usableSubnetworks',
        http_method='GET',
        method_id='container.projects.aggregated.usableSubnetworks.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'pageSize', 'pageToken'],
        relative_path='v1/{+parent}/aggregated/usableSubnetworks',
        request_field='',
  ...
  class ProjectsLocationsClustersNodePoolsService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}/nodePools',
        http_method='POST',
        method_id='container.projects.locations.clusters.nodePools.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1/{+parent}/nodePools',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}/nodePools/{nodePoolsId}',
        http_method='DELETE',
    ...
    Rollback.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}/nodePools/{nodePoolsId}:rollback',
        http_method='POST',
    ...
    SetAutoscaling.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}/nodePools/{nodePoolsId}:setAutoscaling',
        http_method='POST',
        method_id='container.projects.locations.clusters.nodePools.setAutoscaling',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:setAutoscaling',
        request_field='<request>',
    ...
    SetManagement.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}/nodePools/{nodePoolsId}:setManagement',
        http_method='POST',
        method_id='container.projects.locations.clusters.nodePools.setManagement',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:setManagement',
        request_field='<request>',
    ...
    SetSize.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}/nodePools/{nodePoolsId}:setSize',
        http_method='POST',
        method_id='container.projects.locations.clusters.nodePools.setSize',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:setSize',
        request_field='<request>',
  ...
  class ProjectsLocationsClustersWellKnownService(base_api.BaseApiService):
    ...
    GetOpenid_configuration.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}/.well-known/openid-configuration',
        http_method='GET',
        method_id='container.projects.locations.clusters.well-known.getOpenid-configuration',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1/{+parent}/.well-known/openid-configuration',
        request_field='',
  ...
  class ProjectsLocationsClustersService(base_api.BaseApiService):
    ...
    CheckAutopilotCompatibility.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:checkAutopilotCompatibility',
        http_method='GET',
    ...
    CompleteConvertToAutopilot.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:CompleteConvertToAutopilot',
        http_method='POST',
        method_id='container.projects.locations.clusters.completeConvertToAutopilot',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:CompleteConvertToAutopilot',
    ...
    CompleteIpRotation.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:completeIpRotation',
        http_method='POST',
    ...
    GetJwks.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}/jwks',
        http_method='GET',
        method_id='container.projects.locations.clusters.getJwks',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1/{+parent}/jwks',
        request_field='',
    ...
    SetAddons.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:setAddons',
        http_method='POST',
        method_id='container.projects.locations.clusters.setAddons',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:setAddons',
        request_field='<request>',
    ...
    SetLegacyAbac.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:setLegacyAbac',
        http_method='POST',
        method_id='container.projects.locations.clusters.setLegacyAbac',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:setLegacyAbac',
        request_field='<request>',
    ...
    SetLocations.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:setLocations',
        http_method='POST',
        method_id='container.projects.locations.clusters.setLocations',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:setLocations',
        request_field='<request>',
    ...
    SetLogging.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:setLogging',
        http_method='POST',
        method_id='container.projects.locations.clusters.setLogging',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:setLogging',
        request_field='<request>',
    ...
    SetMaintenancePolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:setMaintenancePolicy',
        http_method='POST',
        method_id='container.projects.locations.clusters.setMaintenancePolicy',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:setMaintenancePolicy',
        request_field='<request>',
    ...
    SetMasterAuth.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:setMasterAuth',
        http_method='POST',
        method_id='container.projects.locations.clusters.setMasterAuth',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:setMasterAuth',
        request_field='<request>',
    ...
    SetMonitoring.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:setMonitoring',
        http_method='POST',
        method_id='container.projects.locations.clusters.setMonitoring',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:setMonitoring',
        request_field='<request>',
    ...
    SetNetworkPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:setNetworkPolicy',
        http_method='POST',
        method_id='container.projects.locations.clusters.setNetworkPolicy',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:setNetworkPolicy',
        request_field='<request>',
    ...
    SetResourceLabels.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:setResourceLabels',
        http_method='POST',
        method_id='container.projects.locations.clusters.setResourceLabels',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:setResourceLabels',
        request_field='<request>',
    ...
    StartIpRotation.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:startIpRotation',
        http_method='POST',
        method_id='container.projects.locations.clusters.startIpRotation',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:startIpRotation',
        request_field='<request>',
    ...
    UpdateMaster.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:updateMaster',
        http_method='POST',
        method_id='container.projects.locations.clusters.updateMaster',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:updateMaster',
        request_field='<request>',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    GetServerConfig.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/serverConfig',
        http_method='GET',
        method_id='container.projects.locations.getServerConfig',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['projectId', 'zone'],
        relative_path='v1/{+name}/serverConfig',
        request_field='',
  ...
  class ProjectsZonesClustersNodePoolsService(base_api.BaseApiService):
    ...
    Autoscaling.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools/{nodePoolId}/autoscaling',
        request_field='<request>',
        request_type_name='SetNodePoolAutoscalingRequest',
        response_type_name='Operation',
        supports_download=False,
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools',
        request_field='<request>',
        request_type_name='CreateNodePoolRequest',
        response_type_name='Operation',
        supports_download=False,
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'nodePoolId', 'projectId', 'zone'],
        query_params=['name'],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools/{nodePoolId}',
        request_field='',
    ...
    Rollback.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'nodePoolId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools/{nodePoolId}:rollback',
        request_field='<request>',
        request_type_name='RollbackNodePoolUpgradeRequest',
        response_type_name='Operation',
        supports_download=False,
    ...
    SetManagement.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'nodePoolId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools/{nodePoolId}/setManagement',
        request_field='<request>',
        request_type_name='SetNodePoolManagementRequest',
        response_type_name='Operation',
        supports_download=False,
    ...
    SetSize.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'nodePoolId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools/{nodePoolId}/setSize',
        request_field='<request>',
        request_type_name='SetNodePoolSizeRequest',
        response_type_name='Operation',
        supports_download=False,
    ...
    Update.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'nodePoolId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools/{nodePoolId}/update',
        request_field='<request>',
        request_type_name='UpdateNodePoolRequest',
        response_type_name='Operation',
        supports_download=False,
  ...
  class ProjectsZonesClustersService(base_api.BaseApiService):
    ...
    Addons.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/addons',
        request_field='<request>',
        request_type_name='SetAddonsConfigRequest',
        response_type_name='Operation',
        supports_download=False,
    ...
    CompleteIpRotation.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}:completeIpRotation',
        request_field='<request>',
        request_type_name='CompleteIPRotationRequest',
        response_type_name='Operation',
        supports_download=False,
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters',
        request_field='<request>',
        request_type_name='CreateClusterRequest',
        response_type_name='Operation',
        supports_download=False,
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'projectId', 'zone'],
        query_params=['name'],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}',
        request_field='',
    ...
    LegacyAbac.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/legacyAbac',
        request_field='<request>',
        request_type_name='SetLegacyAbacRequest',
        response_type_name='Operation',
        supports_download=False,
    ...
    Locations.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/locations',
        request_field='<request>',
        request_type_name='SetLocationsRequest',
        response_type_name='Operation',
        supports_download=False,
    ...
    Logging.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/logging',
        request_field='<request>',
        request_type_name='SetLoggingServiceRequest',
        response_type_name='Operation',
        supports_download=False,
    ...
    Master.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/master',
        request_field='<request>',
        request_type_name='UpdateMasterRequest',
        response_type_name='Operation',
        supports_download=False,
    ...
    Monitoring.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/monitoring',
        request_field='<request>',
        request_type_name='SetMonitoringServiceRequest',
        response_type_name='Operation',
        supports_download=False,
    ...
    ResourceLabels.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/resourceLabels',
        request_field='<request>',
        request_type_name='SetLabelsRequest',
        response_type_name='Operation',
        supports_download=False,
    ...
    SetMaintenancePolicy.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}:setMaintenancePolicy',
        request_field='<request>',
        request_type_name='SetMaintenancePolicyRequest',
        response_type_name='Operation',
        supports_download=False,
    ...
    SetMasterAuth.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}:setMasterAuth',
        request_field='<request>',
        request_type_name='SetMasterAuthRequest',
        response_type_name='Operation',
        supports_download=False,
    ...
    SetNetworkPolicy.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}:setNetworkPolicy',
        request_field='<request>',
        request_type_name='SetNetworkPolicyRequest',
        response_type_name='Operation',
        supports_download=False,
    ...
    StartIpRotation.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}:startIpRotation',
        request_field='<request>',
        request_type_name='StartIPRotationRequest',
        response_type_name='Operation',
        supports_download=False,
  ...
  class ProjectsZonesOperationsService(base_api.BaseApiService):
    ...
    Cancel.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=[],
        relative_path='v1/projects/{projectId}/zones/{zone}/operations/{operationId}:cancel',
        request_field='<request>',
        request_type_name='CancelOperationRequest',
        response_type_name='Empty',
        supports_download=False,
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['operationId', 'projectId', 'zone'],
        query_params=['name'],
        relative_path='v1/projects/{projectId}/zones/{zone}/operations/{operationId}',
        request_field='',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['projectId', 'zone'],
        query_params=['parent'],
        relative_path='v1/projects/{projectId}/zones/{zone}/operations',
        request_field='',
  ...
  class ProjectsZonesService(base_api.BaseApiService):
    ...
    GetServerconfig.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['projectId', 'zone'],
        query_params=['name'],
        relative_path='v1/projects/{projectId}/zones/{zone}/serverconfig',
        request_field='',
