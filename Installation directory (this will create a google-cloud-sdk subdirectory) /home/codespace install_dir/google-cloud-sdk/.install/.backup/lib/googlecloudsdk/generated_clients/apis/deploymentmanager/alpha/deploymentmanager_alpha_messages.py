...
class Resource(_messages.Message):
  ...
  Enums:
    RuntimePoliciesValueListEntryValuesEnum:
  ...
  class RuntimePoliciesValueListEntryValuesEnum(_messages.Enum):
    r"""RuntimePoliciesValueListEntryValuesEnum enum type.
  ...
  runtimePolicies = _messages.EnumField('RuntimePoliciesValueListEntryValuesEnum', 9, repeated=True)
...
class ResourceUpdate(_messages.Message):
  ...
  intent = _messages.EnumField('IntentValueValuesEnum', 5)
  manifest = _messages.StringField(6)
  properties = _messages.StringField(7)
  runtimePolicies = _messages.EnumField('RuntimePoliciesValueListEntryValuesEnum', 8, repeated=True)
