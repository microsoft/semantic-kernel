...
from googlecloudsdk.generated_clients.apis.edgecontainer.v1 import edgecontainer_v1_messages as messages
...
class EdgecontainerV1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsClustersNodePoolsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EdgecontainerV1.ProjectsLocationsClustersNodePoolsService, self).__init__(client)
  ...
  class ProjectsLocationsClustersService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EdgecontainerV1.ProjectsLocationsClustersService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    GenerateAccessToken.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:generateAccessToken',
        http_method='GET',
        method_id='edgecontainer.projects.locations.clusters.generateAccessToken',
        ordered_params=['cluster'],
        path_params=['cluster'],
        query_params=[],
        relative_path='v1/{+cluster}:generateAccessToken',
        request_field='',
  ...
  class ProjectsLocationsMachinesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EdgecontainerV1.ProjectsLocationsMachinesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/machines/{machinesId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/machines',
        http_method='GET',
        method_id='edgecontainer.projects.locations.machines.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1/{+parent}/machines',
        request_field='',
  ...
  class ProjectsLocationsOperationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EdgecontainerV1.ProjectsLocationsOperationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsLocationsVpnConnectionsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EdgecontainerV1.ProjectsLocationsVpnConnectionsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/vpnConnections',
        http_method='POST',
        method_id='edgecontainer.projects.locations.vpnConnections.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['requestId', 'vpnConnectionId'],
        relative_path='v1/{+parent}/vpnConnections',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/vpnConnections/{vpnConnectionsId}',
        http_method='DELETE',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EdgecontainerV1.ProjectsLocationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EdgecontainerV1.ProjectsService, self).__init__(client)
      self._upload_configs = {
          }
