"""Generated client library for essentialcontacts version v1alpha1."""
...
class EssentialcontactsV1alpha1(base_api.BaseApiClient):
  """Generated client library for service essentialcontacts version v1alpha1."""
  ...
  _CLIENT_CLASS_NAME = 'EssentialcontactsV1alpha1'
  ...
  def __init__(self, url='', credentials=None,
    ...
    super(EssentialcontactsV1alpha1, self).__init__(
  ...
  class FoldersContactsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EssentialcontactsV1alpha1.FoldersContactsService, self).__init__(client)
    ...
    Compute.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/folders/{foldersId}/contacts:compute',
        http_method='GET',
        method_id='essentialcontacts.folders.contacts.compute',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['includeUnverifiedContacts', 'notificationCategories', 'notificationCategory', 'pageSize', 'pageToken'],
        relative_path='v1alpha1/{+parent}/contacts:compute',
        request_field='',
        request_type_name='EssentialcontactsFoldersContactsComputeRequest',
        response_type_name='GoogleCloudEssentialcontactsV1alpha1ComputeContactsResponse',
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/folders/{foldersId}/contacts',
        http_method='POST',
        method_id='essentialcontacts.folders.contacts.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1alpha1/{+parent}/contacts',
        request_field='googleCloudEssentialcontactsV1alpha1Contact',
        request_type_name='EssentialcontactsFoldersContactsCreateRequest',
        response_type_name='GoogleCloudEssentialcontactsV1alpha1Contact',
        supports_download=False,
    )
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/folders/{foldersId}/contacts/{contactsId}',
        http_method='DELETE',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        response_type_name='GoogleCloudEssentialcontactsV1alpha1ListContactsResponse',
        supports_download=False,
    )
    ...
    def Resend(self, request, global_params=None):
      r"""Allows user to resend verification. This will also update the verification expiration date.
    ...
    Resend.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/folders/{foldersId}/contacts/{contactsId}:resend',
        http_method='POST',
        method_id='essentialcontacts.folders.contacts.resend',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}:resend',
        request_field='googleCloudEssentialcontactsV1alpha1ResendVerificationRequest',
        request_type_name='EssentialcontactsFoldersContactsResendRequest',
        response_type_name='GoogleCloudEssentialcontactsV1alpha1Contact',
        supports_download=False,
    )
    ...
    SendTestMessage.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/folders/{foldersId}/contacts:sendTestMessage',
        http_method='POST',
        method_id='essentialcontacts.folders.contacts.sendTestMessage',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=[],
        relative_path='v1alpha1/{+resource}/contacts:sendTestMessage',
        request_field='googleCloudEssentialcontactsV1alpha1SendTestMessageRequest',
    ...
    def Verify(self, request, global_params=None):
      r"""Verifies the email of a contact. This method does not require any authorization; authorization is based solely on the validity of the verification_token.
    ...
    Verify.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/folders/{foldersId}/contacts/{contactsId}:verify',
        http_method='POST',
        method_id='essentialcontacts.folders.contacts.verify',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}:verify',
        request_field='googleCloudEssentialcontactsV1alpha1VerifyContactRequest',
        request_type_name='EssentialcontactsFoldersContactsVerifyRequest',
        response_type_name='GoogleProtobufEmpty',
        supports_download=False,
    )
  ...
  class FoldersService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EssentialcontactsV1alpha1.FoldersService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class OrganizationsContactsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EssentialcontactsV1alpha1.OrganizationsContactsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Compute.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/organizations/{organizationsId}/contacts:compute',
        http_method='GET',
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/organizations/{organizationsId}/contacts',
        http_method='POST',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/organizations/{organizationsId}/contacts/{contactsId}',
        http_method='DELETE',
    ...
    Resend.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/organizations/{organizationsId}/contacts/{contactsId}:resend',
        http_method='POST',
        method_id='essentialcontacts.organizations.contacts.resend',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}:resend',
        request_field='googleCloudEssentialcontactsV1alpha1ResendVerificationRequest',
        request_type_name='EssentialcontactsOrganizationsContactsResendRequest',
        response_type_name='GoogleCloudEssentialcontactsV1alpha1Contact',
        supports_download=False,
    )
    ...
    SendTestMessage.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/organizations/{organizationsId}/contacts:sendTestMessage',
        http_method='POST',
    ...
    Verify.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/organizations/{organizationsId}/contacts/{contactsId}:verify',
        http_method='POST',
        method_id='essentialcontacts.organizations.contacts.verify',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}:verify',
        request_field='googleCloudEssentialcontactsV1alpha1VerifyContactRequest',
        request_type_name='EssentialcontactsOrganizationsContactsVerifyRequest',
        response_type_name='GoogleProtobufEmpty',
        supports_download=False,
    )
  ...
  class OrganizationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EssentialcontactsV1alpha1.OrganizationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsContactsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EssentialcontactsV1alpha1.ProjectsContactsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Compute.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/contacts:compute',
        http_method='GET',
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/contacts',
        http_method='POST',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/contacts/{contactsId}',
        http_method='DELETE',
    ...
    Resend.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/contacts/{contactsId}:resend',
        http_method='POST',
        method_id='essentialcontacts.projects.contacts.resend',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}:resend',
        request_field='googleCloudEssentialcontactsV1alpha1ResendVerificationRequest',
        request_type_name='EssentialcontactsProjectsContactsResendRequest',
        response_type_name='GoogleCloudEssentialcontactsV1alpha1Contact',
        supports_download=False,
    )
    ...
    SendTestMessage.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/contacts:sendTestMessage',
        http_method='POST',
    ...
    Verify.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/contacts/{contactsId}:verify',
        http_method='POST',
        method_id='essentialcontacts.projects.contacts.verify',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}:verify',
        request_field='googleCloudEssentialcontactsV1alpha1VerifyContactRequest',
        request_type_name='EssentialcontactsProjectsContactsVerifyRequest',
        response_type_name='GoogleProtobufEmpty',
        supports_download=False,
    )
  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EssentialcontactsV1alpha1.ProjectsService, self).__init__(client)
      self._upload_configs = {
          }
