"""Generated client library for parallelstore version v1beta."""
...
class ParallelstoreV1beta(base_api.BaseApiClient):
  """Generated client library for service parallelstore version v1beta."""
  ...
  _CLIENT_CLASS_NAME = 'ParallelstoreV1beta'
  _URL_VERSION = 'v1beta'
  _API_KEY = None
  ...
  def __init__(self, url='', credentials=None,
    ...
    super(ParallelstoreV1beta, self).__init__(
  ...
  class ProjectsLocationsOperationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ParallelstoreV1beta.ProjectsLocationsOperationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ParallelstoreV1beta.ProjectsLocationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ParallelstoreV1beta.ProjectsService, self).__init__(client)
      self._upload_configs = {
          }
