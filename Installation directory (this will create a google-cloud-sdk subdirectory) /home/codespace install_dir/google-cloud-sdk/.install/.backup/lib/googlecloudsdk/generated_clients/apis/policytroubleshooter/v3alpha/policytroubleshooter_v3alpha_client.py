...
class PolicytroubleshooterV3alpha(base_api.BaseApiClient):
  ...
  class GcpUserAccessBindingService(base_api.BaseApiService):
    ...
    def Troubleshoot(self, request, global_params=None):
      r"""Checks why an access is granted or not with GcpUserAccessBinding.
    ...
    Troubleshoot.method_config = lambda: base_api.ApiMethodInfo(
        http_method='POST',
        method_id='policytroubleshooter.gcpUserAccessBinding.troubleshoot',
        ordered_params=[],
        path_params=[],
        query_params=[],
        relative_path='v3alpha/gcpUserAccessBinding:troubleshoot',
        request_field='<request>',
        request_type_name='GoogleCloudPolicytroubleshooterGcpuseraccessbindingV3alphaTroubleshootGcpUserAccessBindingRequest',
