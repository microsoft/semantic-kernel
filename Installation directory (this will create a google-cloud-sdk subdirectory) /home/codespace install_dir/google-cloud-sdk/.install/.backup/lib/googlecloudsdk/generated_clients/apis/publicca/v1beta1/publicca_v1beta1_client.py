"""Generated client library for publicca version v1beta1."""
...
class PubliccaV1beta1(base_api.BaseApiClient):
  """Generated client library for service publicca version v1beta1."""
  ...
  _CLIENT_CLASS_NAME = 'PubliccaV1beta1'
  ...
  def __init__(self, url='', credentials=None,
    ...
    super(PubliccaV1beta1, self).__init__(
  ...
  class ProjectsLocationsExternalAccountKeysService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(PubliccaV1beta1.ProjectsLocationsExternalAccountKeysService, self).__init__(client)
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/externalAccountKeys',
        http_method='POST',
        method_id='publicca.projects.locations.externalAccountKeys.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1beta1/{+parent}/externalAccountKeys',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(PubliccaV1beta1.ProjectsLocationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(PubliccaV1beta1.ProjectsService, self).__init__(client)
      self._upload_configs = {
          }
