...
class AdminQuotaPolicy(_messages.Message):
  ...
  Messages:
    DimensionsValue:  If this map is nonempty, then this policy applies only
      ...
      must be a valid Cloud zone. *   Keys other than "region" or "zone" are
      not valid.
  ...
  Fields:
    ...
    dimensions:  If this map is nonempty, then this policy applies only to
      ...
      following restrictions:  *   If "region" appears as a key, its value
      must be a valid Cloud region. *   If "zone" appears as a key, its value
      must be a valid Cloud zone. *   Keys other than "region" or "zone" are
      not valid.
    ...
    name: The resource name of the policy. This name is generated by the
      server when the policy is created.  Example names would be: `organizatio
      ns/123/services/compute.googleapis.com/consumerQuotaMetrics/compute.goog
      leapis.com%2Fcpus/limits/%2Fproject%2Fregion/adminQuotaPolicies/4a3f2c1d
      `
...
class ConsumerQuotaMetric(_messages.Message):
  ...
  Fields:
    ...
    name: The resource name of the quota settings on this metric for this
      consumer.  An example name would be: `projects/123/services/compute.goog
      leapis.com/consumerQuotaMetrics/compute.googleapis.com%2Fcpus  The
      resource name is intended to be opaque and should not be parsed for its
  ...
  consumerQuotaLimits = _messages.MessageField('ConsumerQuotaLimit', 1, repeated=True)
...
class ListAdminOverridesResponse(_messages.Message):
...
class QuotaBucket(_messages.Message):
  r"""A quota bucket is a quota provisioning unit for a specific set of
  dimensions.
  ...
  @encoding.MapUnrecognizedFields('additionalProperties')
  class DimensionsValue(_messages.Message):
    r"""The dimensions of this quota bucket.  If this map is empty, this is
  ...
  adminOverride = _messages.MessageField('QuotaOverride', 1)
  consumerOverride = _messages.MessageField('QuotaOverride', 2)
  ...
  producerOverride = _messages.MessageField('QuotaOverride', 6)
...
class ServiceusageServicesConsumerQuotaMetricsGetRequest(_messages.Message):
  r"""A ServiceusageServicesConsumerQuotaMetricsGetRequest object.
...
class ServiceusageServicesConsumerQuotaMetricsImportConsumerOverridesRequest(_messages.Message):
  r"""A ServiceusageServicesConsumerQuotaMetricsImportConsumerOverridesRequest
  object.
...
class ServiceusageServicesConsumerQuotaMetricsLimitsAdminOverridesCreateRequest(_messages.Message):
  r"""A
  ServiceusageServicesConsumerQuotaMetricsLimitsAdminOverridesCreateRequest
  object.
...
class ServiceusageServicesConsumerQuotaMetricsLimitsAdminOverridesDeleteRequest(_messages.Message):
  r"""A
  ServiceusageServicesConsumerQuotaMetricsLimitsAdminOverridesDeleteRequest
  object.
...
class ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesListRequest(_messages.Message):
  r"""A
  ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesListRequest
  object.
...
class ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesPatchRequest(_messages.Message):
  r"""A
  ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesPatchRequest
  object.
...
class ServiceusageServicesConsumerQuotaMetricsLimitsGetRequest(_messages.Message):
  r"""A ServiceusageServicesConsumerQuotaMetricsLimitsGetRequest object.
...
class ServiceusageServicesConsumerQuotaMetricsListRequest(_messages.Message):
  r"""A ServiceusageServicesConsumerQuotaMetricsListRequest object.
...
class ServiceusageServicesGenerateServiceIdentityRequest(_messages.Message):
  r"""A ServiceusageServicesGenerateServiceIdentityRequest object.
...
class Usage(_messages.Message):
  ...
  serviceIdentity = _messages.MessageField('GoogleApiServiceIdentity', 4)
