...
"""Command AnalyzeOrgPolicyGovernedResources API."""
...
DETAILED_HELP = {
    'DESCRIPTION':
        """\
    Analyze organization policies governed resources under a scope.
    """,
    'EXAMPLES':
        """\
    To list 10 resources governed by a constraint in an organization, run:
...
class AnalyzeOrgPolicyGovernedResources(base.ListCommand):
  """Analyze organization policies governed resources under a scope."""
  ...
  def Run(self, args):
    ...
    return client.AnalyzeOrgPolicyGovernedResources(args)
