...
"""`gcloud alpha scc settings services describe` command."""
...
class Describe(base.DescribeCommand):
  """Display effective service settings of Security Command Center(SCC)."""

  detailed_help = {
      'DESCRIPTION':
          """\
      Describe effective service settings of Security Command Center(SCC).
      """,
      'EXAMPLES':
          """\
  ...
  def Run(self, args):
    ...
    return utils.SettingsClient().DescribeService(args)
