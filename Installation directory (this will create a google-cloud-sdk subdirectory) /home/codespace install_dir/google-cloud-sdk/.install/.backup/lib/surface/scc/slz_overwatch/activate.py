...
"""Command to activates an overwatch."""
...
_DETAILED_HELP = {
    'BRIEF':
        'Activate a Secured Landing Zone overwatch.',
    'EXAMPLES':
        textwrap.dedent("""\
          The following command activate an overwatch with ID `overwatch01`
