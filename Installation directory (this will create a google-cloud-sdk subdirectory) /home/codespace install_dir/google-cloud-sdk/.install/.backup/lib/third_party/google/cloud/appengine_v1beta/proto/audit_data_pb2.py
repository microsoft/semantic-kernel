...
# source: google/cloud/appengine_v1beta/proto/audit_data.proto
...
from google.cloud.appengine_v1beta.proto import appengine_pb2 as google_dot_cloud_dot_appengine__v1beta_dot_proto_dot_appengine__pb2
from google.api import annotations_pb2 as google_dot_api_dot_annotations__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/appengine_v1beta/proto/audit_data.proto',
  package='google.appengine.v1beta',
  syntax='proto3',
  serialized_options=b'\n\033com.google.appengine.v1betaB\016AuditDataProtoP\001Z@google.golang.org/genproto/googleapis/appengine/v1beta;appengine',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n4google/cloud/appengine_v1beta/proto/audit_data.proto\x12\x17google.appengine.v1beta\x1a\x33google/cloud/appengine_v1beta/proto/appengine.proto\x1a\x1cgoogle/api/annotations.proto\"\xa5\x01\n\tAuditData\x12\x46\n\x0eupdate_service\x18\x01 \x01(\x0b\x32,.google.appengine.v1beta.UpdateServiceMethodH\x00\x12\x46\n\x0e\x63reate_version\x18\x02 \x01(\x0b\x32,.google.appengine.v1beta.CreateVersionMethodH\x00\x42\x08\n\x06method\"U\n\x13UpdateServiceMethod\x12>\n\x07request\x18\x01 \x01(\x0b\x32-.google.appengine.v1beta.UpdateServiceRequest\"U\n\x13\x43reateVersionMethod\x12>\n\x07request\x18\x01 \x01(\x0b\x32-.google.appengine.v1beta.CreateVersionRequestBq\n\x1b\x63om.google.appengine.v1betaB\x0e\x41uditDataProtoP\x01Z@google.golang.org/genproto/googleapis/appengine/v1beta;appengineb\x06proto3'
  ,
  dependencies=[google_dot_cloud_dot_appengine__v1beta_dot_proto_dot_appengine__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,])
...
_AUDITDATA = _descriptor.Descriptor(
  name='AuditData',
  full_name='google.appengine.v1beta.AuditData',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='update_service', full_name='google.appengine.v1beta.AuditData.update_service', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='create_version', full_name='google.appengine.v1beta.AuditData.create_version', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='method', full_name='google.appengine.v1beta.AuditData.method',
...
_UPDATESERVICEMETHOD = _descriptor.Descriptor(
  ...
  full_name='google.appengine.v1beta.UpdateServiceMethod',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='request', full_name='google.appengine.v1beta.UpdateServiceMethod.request', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CREATEVERSIONMETHOD = _descriptor.Descriptor(
  ...
  full_name='google.appengine.v1beta.CreateVersionMethod',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='request', full_name='google.appengine.v1beta.CreateVersionMethod.request', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UPDATESERVICEMETHOD.fields_by_name['request'].message_type = google_dot_cloud_dot_appengine__v1beta_dot_proto_dot_appengine__pb2._UPDATESERVICEREQUEST
_CREATEVERSIONMETHOD.fields_by_name['request'].message_type = google_dot_cloud_dot_appengine__v1beta_dot_proto_dot_appengine__pb2._CREATEVERSIONREQUEST
...
AuditData = _reflection.GeneratedProtocolMessageType('AuditData', (_message.Message,), {
  ...
  '__module__' : 'google.cloud.appengine_v1beta.proto.audit_data_pb2'
  ,
