...
# source: google/cloud/appengine_v1beta/proto/certificate.proto
...
_MANAGEMENTSTATUS = _descriptor.EnumDescriptor(
  ...
  full_name='google.appengine.v1beta.ManagementStatus',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_AUTHORIZEDCERTIFICATE = _descriptor.Descriptor(
  ...
  full_name='google.appengine.v1beta.AuthorizedCertificate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.appengine.v1beta.AuthorizedCertificate.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='google.appengine.v1beta.AuthorizedCertificate.id', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='display_name', full_name='google.appengine.v1beta.AuthorizedCertificate.display_name', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='domain_names', full_name='google.appengine.v1beta.AuthorizedCertificate.domain_names', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='expire_time', full_name='google.appengine.v1beta.AuthorizedCertificate.expire_time', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='certificate_raw_data', full_name='google.appengine.v1beta.AuthorizedCertificate.certificate_raw_data', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='managed_certificate', full_name='google.appengine.v1beta.AuthorizedCertificate.managed_certificate', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='visible_domain_mappings', full_name='google.appengine.v1beta.AuthorizedCertificate.visible_domain_mappings', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='domain_mappings_count', full_name='google.appengine.v1beta.AuthorizedCertificate.domain_mappings_count', index=8,
...
_CERTIFICATERAWDATA = _descriptor.Descriptor(
  ...
  full_name='google.appengine.v1beta.CertificateRawData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='public_certificate', full_name='google.appengine.v1beta.CertificateRawData.public_certificate', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='private_key', full_name='google.appengine.v1beta.CertificateRawData.private_key', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MANAGEDCERTIFICATE = _descriptor.Descriptor(
  ...
  full_name='google.appengine.v1beta.ManagedCertificate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='last_renewal_time', full_name='google.appengine.v1beta.ManagedCertificate.last_renewal_time', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='google.appengine.v1beta.ManagedCertificate.status', index=1,
...
AuthorizedCertificate = _reflection.GeneratedProtocolMessageType('AuthorizedCertificate', (_message.Message,), {
  ...
  '__module__' : 'google.cloud.appengine_v1beta.proto.certificate_pb2'
  ,
