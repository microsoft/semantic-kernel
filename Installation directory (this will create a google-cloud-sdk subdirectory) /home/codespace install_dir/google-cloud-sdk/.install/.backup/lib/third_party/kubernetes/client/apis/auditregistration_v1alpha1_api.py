...
class AuditregistrationV1alpha1Api(object):
  ...
  def create_audit_sink_with_http_info(self, body, **kwargs):
    """
        create an AuditSink
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    return self.api_client.call_api(
        ...
        response_type='V1alpha1AuditSink',
  ...
  def delete_audit_sink_with_http_info(self, name, **kwargs):
    """
        delete an AuditSink
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
  ...
  def delete_collection_audit_sink(self, **kwargs):
    """
    ...
    kwargs['_return_http_data_only'] = True
    if kwargs.get('async_req'):
      return self.delete_collection_audit_sink_with_http_info(**kwargs)
    else:
      (data) = self.delete_collection_audit_sink_with_http_info(**kwargs)
      return data

  def delete_collection_audit_sink_with_http_info(self, **kwargs):
    """
        delete collection of AuditSink
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread =
        api.delete_collection_audit_sink_with_http_info(async_req=True)
        >>> result = thread.get()
  ...
  def list_audit_sink_with_http_info(self, **kwargs):
    """
        list or watch objects of kind AuditSink
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    return self.api_client.call_api(
        ...
        post_params=form_params,
        files=local_var_files,
        response_type='V1alpha1AuditSinkList',
        auth_settings=auth_settings,
        async_req=params.get('async_req'),
        _return_http_data_only=params.get('_return_http_data_only'),
        _preload_content=params.get('_preload_content', True),
  ...
  def patch_audit_sink_with_http_info(self, name, body, **kwargs):
    """
        partially update the specified AuditSink
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_audit_sink_with_http_info(name, body,
        async_req=True)
        >>> result = thread.get()
  ...
  def read_audit_sink_with_http_info(self, name, **kwargs):
    """
        read the specified AuditSink
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
  ...
  def replace_audit_sink_with_http_info(self, name, body, **kwargs):
    """
        replace the specified AuditSink
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.replace_audit_sink_with_http_info(name, body,
        async_req=True)
        >>> result = thread.get()
