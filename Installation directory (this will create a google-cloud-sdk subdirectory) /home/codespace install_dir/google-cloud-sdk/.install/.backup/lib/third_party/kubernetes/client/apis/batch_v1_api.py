...
class BatchV1Api(object):
  ...
  def create_namespaced_job(self, namespace, body, **kwargs):
    ...
    if kwargs.get('async_req'):
      return self.create_namespaced_job_with_http_info(namespace, body,
                                                       **kwargs)
    else:
      (data) = self.create_namespaced_job_with_http_info(
  ...
  def delete_collection_namespaced_job(self, namespace, **kwargs):
    ...
    kwargs['_return_http_data_only'] = True
    if kwargs.get('async_req'):
      return self.delete_collection_namespaced_job_with_http_info(
          namespace, **kwargs)
    else:
      (data) = self.delete_collection_namespaced_job_with_http_info(
          namespace, **kwargs)
      return data

  def delete_collection_namespaced_job_with_http_info(self, namespace,
                                                      **kwargs):
    """
        delete collection of Job
        This method makes a synchronous HTTP request by default. To make an
  ...
  def delete_namespaced_job(self, name, namespace, **kwargs):
    ...
    if kwargs.get('async_req'):
      ...
      (data) = self.delete_namespaced_job_with_http_info(
  ...
  def patch_namespaced_job(self, name, namespace, body, **kwargs):
    ...
    kwargs['_return_http_data_only'] = True
    if kwargs.get('async_req'):
      return self.patch_namespaced_job_with_http_info(name, namespace, body,
                                                      **kwargs)
    else:
      (data) = self.patch_namespaced_job_with_http_info(name, namespace, body,
                                                        **kwargs)
      return data

  def patch_namespaced_job_with_http_info(self, name, namespace, body,
                                          **kwargs):
    """
        partially update the specified Job
        This method makes a synchronous HTTP request by default. To make an
  ...
  def patch_namespaced_job_status(self, name, namespace, body, **kwargs):
    ...
    kwargs['_return_http_data_only'] = True
    if kwargs.get('async_req'):
      return self.patch_namespaced_job_status_with_http_info(
          name, namespace, body, **kwargs)
    else:
      (data) = self.patch_namespaced_job_status_with_http_info(
          name, namespace, body, **kwargs)
      return data

  def patch_namespaced_job_status_with_http_info(self, name, namespace, body,
                                                 **kwargs):
    """
        partially update status of the specified Job
        This method makes a synchronous HTTP request by default. To make an
  ...
  def read_namespaced_job(self, name, namespace, **kwargs):
    ...
    if kwargs.get('async_req'):
      ...
      (data) = self.read_namespaced_job_with_http_info(name, namespace,
                                                       **kwargs)
      return data
  ...
  def read_namespaced_job_status(self, name, namespace, **kwargs):
    ...
    kwargs['_return_http_data_only'] = True
    if kwargs.get('async_req'):
      return self.read_namespaced_job_status_with_http_info(
          name, namespace, **kwargs)
    else:
      (data) = self.read_namespaced_job_status_with_http_info(
          name, namespace, **kwargs)
      return data

  def read_namespaced_job_status_with_http_info(self, name, namespace,
                                                **kwargs):
    """
        read status of the specified Job
        This method makes a synchronous HTTP request by default. To make an
  ...
  def replace_namespaced_job(self, name, namespace, body, **kwargs):
    ...
    kwargs['_return_http_data_only'] = True
    if kwargs.get('async_req'):
      return self.replace_namespaced_job_with_http_info(name, namespace, body,
                                                        **kwargs)
    else:
      (data) = self.replace_namespaced_job_with_http_info(
          name, namespace, body, **kwargs)
      return data

  def replace_namespaced_job_with_http_info(self, name, namespace, body,
                                            **kwargs):
    """
        replace the specified Job
        This method makes a synchronous HTTP request by default. To make an
  ...
  def replace_namespaced_job_status(self, name, namespace, body, **kwargs):
    ...
    kwargs['_return_http_data_only'] = True
    if kwargs.get('async_req'):
      return self.replace_namespaced_job_status_with_http_info(
          name, namespace, body, **kwargs)
    else:
      (data) = self.replace_namespaced_job_status_with_http_info(
          name, namespace, body, **kwargs)
      return data

  def replace_namespaced_job_status_with_http_info(self, name, namespace, body,
                                                   **kwargs):
    """
        replace status of the specified Job
        This method makes a synchronous HTTP request by default. To make an
