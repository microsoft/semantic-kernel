...
class NodeV1alpha1Api(object):
  ...
  def create_runtime_class_with_http_info(self, body, **kwargs):
    """
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_runtime_class_with_http_info(body,
        async_req=True)
        >>> result = thread.get()
    ...
    return self.api_client.call_api(
        ...
        response_type='V1alpha1RuntimeClass',
  ...
  def delete_collection_runtime_class_with_http_info(self, **kwargs):
    """
        ...
        asynchronous HTTP request, please pass async_req=True
        >>> thread =
        api.delete_collection_runtime_class_with_http_info(async_req=True)
        >>> result = thread.get()
  ...
  def delete_runtime_class_with_http_info(self, name, **kwargs):
    """
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_runtime_class_with_http_info(name,
        async_req=True)
        >>> result = thread.get()
    ...
    if ('name' not in params) or (params['name'] is None):
      raise ValueError(
          'Missing the required parameter `name` when calling `delete_runtime_class`'
      )
  ...
  def list_runtime_class_with_http_info(self, **kwargs):
    ...
    return self.api_client.call_api(
        ...
        post_params=form_params,
        files=local_var_files,
        response_type='V1alpha1RuntimeClassList',
        auth_settings=auth_settings,
        async_req=params.get('async_req'),
        _return_http_data_only=params.get('_return_http_data_only'),
        _preload_content=params.get('_preload_content', True),
  ...
  def patch_runtime_class_with_http_info(self, name, body, **kwargs):
    """
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_runtime_class_with_http_info(name, body,
        async_req=True)
        >>> result = thread.get()
    ...
    if ('name' not in params) or (params['name'] is None):
      raise ValueError(
          'Missing the required parameter `name` when calling `patch_runtime_class`'
      )
    # verify the required parameter 'body' is set
    if ('body' not in params) or (params['body'] is None):
      raise ValueError(
          'Missing the required parameter `body` when calling `patch_runtime_class`'
      )
  ...
  def replace_runtime_class_with_http_info(self, name, body, **kwargs):
    """
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.replace_runtime_class_with_http_info(name, body,
        async_req=True)
        >>> result = thread.get()
