...
class ExtensionsV1beta1HTTPIngressRuleValue(object):
  ...
  """
    Attributes:
      ...
      attribute_map (dict): The key is attribute name and the value is json key
        in definition.
  """
  swagger_types = {'paths': 'list[ExtensionsV1beta1HTTPIngressPath]'}

  attribute_map = {'paths': 'paths'}

  def __init__(self, paths=None):
    """
        ExtensionsV1beta1HTTPIngressRuleValue - a model defined in Swagger
        """
  ...
  def paths(self):
    """
        Gets the paths of this ExtensionsV1beta1HTTPIngressRuleValue.
