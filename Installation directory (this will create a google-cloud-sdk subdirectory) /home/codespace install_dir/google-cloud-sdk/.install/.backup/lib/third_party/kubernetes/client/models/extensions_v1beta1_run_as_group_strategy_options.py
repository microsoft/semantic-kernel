...
class ExtensionsV1beta1RunAsGroupStrategyOptions(object):
  """
  ...
  """
    Attributes:
      ...
      attribute_map (dict): The key is attribute name and the value is json key
        in definition.
  """
  swagger_types = {'ranges': 'list[ExtensionsV1beta1IDRange]', 'rule': 'str'}
  ...
  def __eq__(self, other):
    """
        ...
        """
    if not isinstance(other, ExtensionsV1beta1RunAsGroupStrategyOptions):
      return False
