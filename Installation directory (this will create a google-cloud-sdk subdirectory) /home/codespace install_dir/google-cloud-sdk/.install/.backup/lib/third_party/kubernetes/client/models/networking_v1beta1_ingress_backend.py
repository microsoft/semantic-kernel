...
class NetworkingV1beta1IngressBackend(object):
  ...
  """
    Attributes:
      ...
      attribute_map (dict): The key is attribute name and the value is json key
        in definition.
  """
  swagger_types = {'service_name': 'str', 'service_port': 'object'}

  attribute_map = {'service_name': 'serviceName', 'service_port': 'servicePort'}

  def __init__(self, service_name=None, service_port=None):
    """
        NetworkingV1beta1IngressBackend - a model defined in Swagger
        """
  ...
  def service_name(self):
    """
        Gets the service_name of this NetworkingV1beta1IngressBackend.
        Specifies the name of the referenced service.

        :return: The service_name of this NetworkingV1beta1IngressBackend.
        :rtype: str
        """
  ...
  def service_name(self, service_name):
    """
        ...
        :param service_name: The service_name of this
  ...
  def service_port(self):
    """
        Gets the service_port of this NetworkingV1beta1IngressBackend.
        Specifies the port of the referenced service.

        :return: The service_port of this NetworkingV1beta1IngressBackend.
        :rtype: object
        """
