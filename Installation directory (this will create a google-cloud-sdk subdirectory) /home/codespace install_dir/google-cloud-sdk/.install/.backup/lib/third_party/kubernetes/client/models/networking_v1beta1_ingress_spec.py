...
class NetworkingV1beta1IngressSpec(object):
  ...
  attribute_map = {'backend': 'backend', 'rules': 'rules', 'tls': 'tls'}

  def __init__(self, backend=None, rules=None, tls=None):
    """
        NetworkingV1beta1IngressSpec - a model defined in Swagger
        """
  ...
  def backend(self):
    """
        Gets the backend of this NetworkingV1beta1IngressSpec.
        A default backend capable of servicing requests that don't match any
        rule. At least one of 'backend' or 'rules' must be specified. This field
        is optional to allow the loadbalancer controller or defaulting logic to
        specify a global default.

        :return: The backend of this NetworkingV1beta1IngressSpec.
  ...
  def backend(self, backend):
    """
        ...
        :param backend: The backend of this NetworkingV1beta1IngressSpec.
  ...
  def rules(self):
    """
        Gets the rules of this NetworkingV1beta1IngressSpec.
        A list of host rules used to configure the Ingress. If unspecified, or
        no rule matches, all traffic is sent to the default backend.

        :return: The rules of this NetworkingV1beta1IngressSpec.
  ...
  def rules(self, rules):
    """
        ...
        :param rules: The rules of this NetworkingV1beta1IngressSpec.
  ...
  def tls(self):
    """
        Gets the tls of this NetworkingV1beta1IngressSpec.
        ...
        :return: The tls of this NetworkingV1beta1IngressSpec.
