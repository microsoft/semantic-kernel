...
class V1VolumeError(object):
  ...
  """
    Attributes:
      ...
      attribute_map (dict): The key is attribute name and the value is json key
        in definition.
  """
  swagger_types = {'message': 'str', 'time': 'datetime'}

  attribute_map = {'message': 'message', 'time': 'time'}

  def __init__(self, message=None, time=None):
    """
        V1VolumeError - a model defined in Swagger
        """
  ...
  def message(self):
    """
        Gets the message of this V1VolumeError.
        ...
        :return: The message of this V1VolumeError.
        :rtype: str
        """
  ...
  def message(self, message):
    """
        ...
        :param message: The message of this V1VolumeError.
        :type: str
        """
  ...
  def time(self):
    """
        Gets the time of this V1VolumeError.
        Time the error was encountered.

        :return: The time of this V1VolumeError.
        :rtype: datetime
        """
    return self._time
  ...
  def time(self, time):
    """
        ...
        :param time: The time of this V1VolumeError.
        :type: datetime
        """
