...
class V1alpha1Policy(object):
  ...
  """
    Attributes:
      ...
      attribute_map (dict): The key is attribute name and the value is json key
        in definition.
  """
  swagger_types = {'level': 'str', 'stages': 'list[str]'}

  attribute_map = {'level': 'level', 'stages': 'stages'}

  def __init__(self, level=None, stages=None):
    """
        V1alpha1Policy - a model defined in Swagger
        """
  ...
  def level(self):
    """
        Gets the level of this V1alpha1Policy.
        The Level that all requests are recorded at. available options: None,
        Metadata, Request, RequestResponse required

        :return: The level of this V1alpha1Policy.
        :rtype: str
        """
    return self._level
  ...
  def level(self, level):
    """
        ...
        :param level: The level of this V1alpha1Policy.
        :type: str
        """
    if level is None:
  ...
  def stages(self):
    """
        Gets the stages of this V1alpha1Policy.
        Stages is a list of stages for which events are created.

        :return: The stages of this V1alpha1Policy.
        :rtype: list[str]
        """
    return self._stages
