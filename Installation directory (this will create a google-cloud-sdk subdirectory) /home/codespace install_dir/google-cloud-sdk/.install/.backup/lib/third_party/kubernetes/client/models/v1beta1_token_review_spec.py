...
class V1beta1TokenReviewSpec(object):
  ...
  def audiences(self):
    """
        Gets the audiences of this V1beta1TokenReviewSpec.
        ...
        :return: The audiences of this V1beta1TokenReviewSpec.
        :rtype: list[str]
        """
  ...
  def audiences(self, audiences):
    """
        Sets the audiences of this V1beta1TokenReviewSpec.
        Audiences is a list of the identifiers that the resource server
        presented with the token identifies as. Audience-aware token
        authenticators will verify that the token was intended for at least one
        of the audiences in this list. If no audiences are provided, the
        ...
        :param audiences: The audiences of this V1beta1TokenReviewSpec.
        :type: list[str]
        """
