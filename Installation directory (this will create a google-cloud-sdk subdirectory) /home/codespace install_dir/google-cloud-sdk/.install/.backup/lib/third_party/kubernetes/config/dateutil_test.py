...
class DateUtilTest(unittest.TestCase):
  ...
  def test_parse_rfc3339(self):
    ...
    self._parse_rfc3339_test("2017-07-25T04:44:21z", 2017, 7, 25, 4, 44, 21)
    self._parse_rfc3339_test("2017-07-25T04:44:21+03:00", 2017, 7, 25, 1, 44,
                             21)
    self._parse_rfc3339_test("2017-07-25T04:44:21-03:00", 2017, 7, 25, 7, 44,
                             21)
  ...
  def test_format_rfc3339(self):
    ...
    self.assertEqual(
        format_rfc3339(
            datetime(2017, 7, 25, 4, 44, 21, 0, TimezoneInfo(-2, 30))),
