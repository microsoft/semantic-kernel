...
BASE_URL = 'https://batch.googleapis.com/v1alpha/'
...
class Collections(enum.Enum):
  ...
  PROJECTS_LOCATIONS_RESOURCEALLOWANCES = (
      'projects.locations.resourceAllowances',
      '{+name}',
      {
          '':
              'projects/{projectsId}/locations/{locationsId}/'
              'resourceAllowances/{resourceAllowancesId}',
      },
      ['name'],
      True
  )
