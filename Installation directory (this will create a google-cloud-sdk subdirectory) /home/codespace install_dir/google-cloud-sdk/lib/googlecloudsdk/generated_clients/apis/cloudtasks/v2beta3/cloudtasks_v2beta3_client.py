...
from googlecloudsdk.generated_clients.apis.cloudtasks.v2beta3 import cloudtasks_v2beta3_messages as messages
...
class CloudtasksV2beta3(base_api.BaseApiClient):
  ...
  _CLIENT_CLASS_NAME = 'CloudtasksV2beta3'
  _URL_VERSION = 'v2beta3'
  _API_KEY = None
  ...
  class ProjectsLocationsQueuesTasksService(base_api.BaseApiService):
    ...
    Buffer.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}/tasks/{taskId}:buffer',
        http_method='POST',
        method_id='cloudtasks.projects.locations.queues.tasks.buffer',
        ordered_params=['queue', 'taskId'],
        path_params=['queue', 'taskId'],
        query_params=[],
        relative_path='v2beta3/{+queue}/tasks/{taskId}:buffer',
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}/tasks',
        http_method='POST',
        method_id='cloudtasks.projects.locations.queues.tasks.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v2beta3/{+parent}/tasks',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}/tasks/{tasksId}',
        http_method='DELETE',
    ...
    Run.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}/tasks/{tasksId}:run',
        http_method='POST',
        method_id='cloudtasks.projects.locations.queues.tasks.run',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v2beta3/{+name}:run',
  ...
  class ProjectsLocationsQueuesService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2beta3/projects/{projectsId}/locations/{locationsId}/queues',
        http_method='POST',
        method_id='cloudtasks.projects.locations.queues.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v2beta3/{+parent}/queues',
        request_field='queue',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}',
        http_method='DELETE',
    ...
    GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}:getIamPolicy',
        http_method='POST',
        method_id='cloudtasks.projects.locations.queues.getIamPolicy',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=[],
        relative_path='v2beta3/{+resource}:getIamPolicy',
    ...
    Pause.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}:pause',
        http_method='POST',
        method_id='cloudtasks.projects.locations.queues.pause',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v2beta3/{+name}:pause',
    ...
    Purge.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}:purge',
        http_method='POST',
        method_id='cloudtasks.projects.locations.queues.purge',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v2beta3/{+name}:purge',
    ...
    Resume.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}:resume',
        http_method='POST',
        method_id='cloudtasks.projects.locations.queues.resume',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v2beta3/{+name}:resume',
    ...
    SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}:setIamPolicy',
        http_method='POST',
        method_id='cloudtasks.projects.locations.queues.setIamPolicy',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=[],
        relative_path='v2beta3/{+resource}:setIamPolicy',
    ...
    TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}:testIamPermissions',
        http_method='POST',
        method_id='cloudtasks.projects.locations.queues.testIamPermissions',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=[],
        relative_path='v2beta3/{+resource}:testIamPermissions',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2beta3/projects/{projectsId}/locations/{locationsId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2beta3/projects/{projectsId}/locations',
        http_method='GET',
