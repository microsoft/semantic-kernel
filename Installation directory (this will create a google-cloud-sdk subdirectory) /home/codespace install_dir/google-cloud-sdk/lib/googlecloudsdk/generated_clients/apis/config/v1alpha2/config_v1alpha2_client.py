"""Generated client library for config version v1alpha2."""
...
class ConfigV1alpha2(base_api.BaseApiClient):
  """Generated client library for service config version v1alpha2."""
  ...
  _CLIENT_CLASS_NAME = 'ConfigV1alpha2'
  ...
  def __init__(self, url='', credentials=None,
    ...
    super(ConfigV1alpha2, self).__init__(
  ...
  class ProjectsLocationsDeploymentsRevisionsService(base_api.BaseApiService):
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/deployments/{deploymentsId}/revisions/{revisionsId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/deployments/{deploymentsId}/revisions',
        http_method='GET',
        method_id='config.projects.locations.deployments.revisions.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1alpha2/{+parent}/revisions',
        request_field='',
  ...
  class ProjectsLocationsDeploymentsService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/deployments',
        http_method='POST',
        method_id='config.projects.locations.deployments.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['deploymentId', 'requestId'],
        relative_path='v1alpha2/{+parent}/deployments',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/deployments/{deploymentsId}',
        http_method='DELETE',
    ...
    SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/deployments/{deploymentsId}:setIamPolicy',
        http_method='POST',
    ...
    TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/deployments/{deploymentsId}:testIamPermissions',
        http_method='POST',
  ...
  class ProjectsLocationsOperationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConfigV1alpha2.ProjectsLocationsOperationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsLocationsPreviewsService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/previews',
        http_method='POST',
        method_id='config.projects.locations.previews.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['previewId', 'requestId'],
        relative_path='v1alpha2/{+parent}/previews',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/previews/{previewsId}',
        http_method='DELETE',
    ...
    Export.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/previews/{previewsId}:export',
        http_method='POST',
        method_id='config.projects.locations.previews.export',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1alpha2/{+parent}:export',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConfigV1alpha2.ProjectsLocationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConfigV1alpha2.ProjectsService, self).__init__(client)
      self._upload_configs = {
          }
