...
class ContainerV1beta1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsClustersNodePoolsService(base_api.BaseApiService):
    ...
    CompleteUpgrade.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}/nodePools/{nodePoolsId}:completeUpgrade',
        http_method='POST',
        method_id='container.projects.locations.clusters.nodePools.completeUpgrade',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1beta1/{+name}:completeUpgrade',
