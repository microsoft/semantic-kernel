...
from googlecloudsdk.generated_clients.apis.dns.v1 import dns_v1_messages as messages
...
class DnsV1(base_api.BaseApiClient):
  ...
  MTLS_BASE_URL = 'https://dns.mtls.googleapis.com/dns/v1/'
  ...
  class ResponsePoliciesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(DnsV1.ResponsePoliciesService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ResponsePolicyRulesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(DnsV1.ResponsePolicyRulesService, self).__init__(client)
      self._upload_configs = {
          }
