...
class MemcacheV1beta2(base_api.BaseApiClient):
  ...
  class ProjectsLocationsInstancesService(base_api.BaseApiService):
    ...
    Upgrade.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta2/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:upgrade',
        http_method='POST',
        method_id='memcache.projects.locations.instances.upgrade',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1beta2/{+name}:upgrade',
        request_field='googleCloudMemcacheV1beta2UpgradeInstanceRequest',
