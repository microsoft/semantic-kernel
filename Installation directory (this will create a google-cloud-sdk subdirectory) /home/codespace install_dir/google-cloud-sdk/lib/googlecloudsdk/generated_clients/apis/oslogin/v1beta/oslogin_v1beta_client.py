...
class OsloginV1beta(base_api.BaseApiClient):
  ...
  _CLIENT_CLASS_NAME = 'OsloginV1beta'
  _URL_VERSION = 'v1beta'
  _API_KEY = None
  ...
  class UsersProjectsZonesService(base_api.BaseApiService):
    ...
    SignSshPublicKey.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/users/{usersId}/projects/{projectsId}/zones/{zonesId}:signSshPublicKey',
        http_method='POST',
  ...
  class UsersProjectsService(base_api.BaseApiService):
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/users/{usersId}/projects/{projectsId}',
        http_method='DELETE',
  ...
  class UsersSshPublicKeysService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/users/{usersId}/sshPublicKeys',
        http_method='POST',
        method_id='oslogin.users.sshPublicKeys.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1beta/{+parent}/sshPublicKeys',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/users/{usersId}/sshPublicKeys/{sshPublicKeysId}',
        http_method='DELETE',
  ...
  class UsersService(base_api.BaseApiService):
    ...
    GetLoginProfile.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/users/{usersId}/loginProfile',
        http_method='GET',
        method_id='oslogin.users.getLoginProfile',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['projectId', 'systemId', 'view'],
        relative_path='v1beta/{+name}/loginProfile',
        request_field='',
    ...
    ImportSshPublicKey.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/users/{usersId}:importSshPublicKey',
        http_method='POST',
