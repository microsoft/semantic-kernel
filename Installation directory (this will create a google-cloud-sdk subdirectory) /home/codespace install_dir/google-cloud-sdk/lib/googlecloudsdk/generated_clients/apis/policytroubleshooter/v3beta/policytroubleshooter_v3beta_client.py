"""Generated client library for policytroubleshooter version v3beta."""
...
class PolicytroubleshooterV3beta(base_api.BaseApiClient):
  """Generated client library for service policytroubleshooter version v3beta."""
  ...
  _CLIENT_CLASS_NAME = 'PolicytroubleshooterV3beta'
  _URL_VERSION = 'v3beta'
  _API_KEY = None
  ...
  def __init__(self, url='', credentials=None,
    ...
    super(PolicytroubleshooterV3beta, self).__init__(
  ...
  class IamService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(PolicytroubleshooterV3beta.IamService, self).__init__(client)
    ...
    Troubleshoot.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=[],
        query_params=[],
        relative_path='v3beta/iam:troubleshoot',
        request_field='<request>',
        request_type_name='GoogleCloudPolicytroubleshooterIamV3betaTroubleshootIamPolicyRequest',
