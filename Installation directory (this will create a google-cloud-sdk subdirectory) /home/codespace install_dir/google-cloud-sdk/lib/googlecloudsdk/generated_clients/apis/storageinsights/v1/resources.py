...
class Collections(enum.Enum):
  ...
  PROJECTS_LOCATIONS_DATASETCONFIGS = (
      'projects.locations.datasetConfigs',
      '{+name}',
      {
          '':
              'projects/{projectsId}/locations/{locationsId}/datasetConfigs/'
              '{datasetConfigsId}',
      },
      ['name'],
      True
  ...
  PROJECTS_LOCATIONS_REPORTCONFIGS = (
      ...
      {
          '':
              'projects/{projectsId}/locations/{locationsId}/reportConfigs/'
              '{reportConfigsId}',
      },
      ['name'],
      True
  ...
  PROJECTS_LOCATIONS_REPORTCONFIGS_REPORTDETAILS = (
      ...
      '{+name}',
      {
          '':
              'projects/{projectsId}/locations/{locationsId}/reportConfigs/'
              '{reportConfigsId}/reportDetails/{reportDetailsId}',
      },
      ['name'],
      True
  )
