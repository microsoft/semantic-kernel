...
"""Command to describe the application services."""
...
_DETAILED_HELP = {
    ...
    'EXAMPLES': """ \
        To describe the Service `my-service` in the Application `my-app` in
