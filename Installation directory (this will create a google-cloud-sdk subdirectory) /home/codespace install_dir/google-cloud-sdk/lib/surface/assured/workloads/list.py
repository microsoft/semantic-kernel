...
"""Command to list all Assured Workloads environments that belong to a given parent organization."""
...
_DETAILED_HELP = {
    ...
    'EXAMPLES':
        """ \
        The following example command lists all Assured Workloads environments
