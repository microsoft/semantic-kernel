...
"""Commands for reading and manipulating network firewall policies."""
...
NetworkFirewallPolicies.detailed_help = {
    'brief': ('Manage Compute Engine network firewall policies.'),
}
