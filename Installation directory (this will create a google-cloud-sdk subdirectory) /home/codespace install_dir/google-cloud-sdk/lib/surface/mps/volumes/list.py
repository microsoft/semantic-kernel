...
"""'Marketplace Solutions volumes list command."""
...
class List(base.ListCommand):
  """List Marketplace Solution volumes in a project."""
  ...
  def Args(parser):
    ...
    parser.display_info.AddFormat(VOLUME_LIST_FORMAT)
