...
from .base import PartitionAssignmentServiceTransport
from .grpc import PartitionAssignmentServiceGrpcTransport
from .grpc_asyncio import PartitionAssignmentServiceGrpcAsyncIOTransport


# Compile a registry of transports.
_transport_registry = (
    OrderedDict()
)  # type: Dict[str, Type[PartitionAssignmentServiceTransport]]
