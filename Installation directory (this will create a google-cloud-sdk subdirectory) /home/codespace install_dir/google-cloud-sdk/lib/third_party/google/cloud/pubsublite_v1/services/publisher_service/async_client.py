...
class PublisherServiceAsyncClient:
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return PublisherServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def publish(
        self,
        requests: Optional[AsyncIterator[publisher.PublishRequest]] = None,
        *,
