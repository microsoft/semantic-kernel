...
class SubscriberServiceAsyncClient:
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return SubscriberServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def subscribe(
        self,
        requests: Optional[AsyncIterator[subscriber.SubscribeRequest]] = None,
        *,
