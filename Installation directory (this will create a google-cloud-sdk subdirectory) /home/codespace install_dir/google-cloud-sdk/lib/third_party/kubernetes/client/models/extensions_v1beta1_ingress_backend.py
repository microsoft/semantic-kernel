...
class ExtensionsV1beta1IngressBackend(object):
  ...
  def __init__(self, service_name=None, service_port=None):
    """
        ExtensionsV1beta1IngressBackend - a model defined in Swagger
        """
  ...
  def service_name(self):
    """
        Gets the service_name of this ExtensionsV1beta1IngressBackend.
        Specifies the name of the referenced service.

        :return: The service_name of this ExtensionsV1beta1IngressBackend.
        :rtype: str
        """
  ...
  def service_port(self):
    """
        Gets the service_port of this ExtensionsV1beta1IngressBackend.
        Specifies the port of the referenced service.

        :return: The service_port of this ExtensionsV1beta1IngressBackend.
        :rtype: object
        """
