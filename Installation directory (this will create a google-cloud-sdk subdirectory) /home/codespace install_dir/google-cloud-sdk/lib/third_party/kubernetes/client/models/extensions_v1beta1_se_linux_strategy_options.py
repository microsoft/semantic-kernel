...
class ExtensionsV1beta1SELinuxStrategyOptions(object):
  ...
  """
    Attributes:
      ...
      attribute_map (dict): The key is attribute name and the value is json key
        in definition.
  """
  swagger_types = {'rule': 'str', 'se_linux_options': 'V1SELinuxOptions'}

  attribute_map = {'rule': 'rule', 'se_linux_options': 'seLinuxOptions'}
  ...
  def se_linux_options(self):
    """
        Gets the se_linux_options of this
  ...
  def se_linux_options(self, se_linux_options):
    """
        Sets the se_linux_options of this
        ExtensionsV1beta1SELinuxStrategyOptions.
        seLinuxOptions required to run as; required for MustRunAs More info:
        https://kubernetes.io/docs/tasks/configure-pod-container/security-context/
