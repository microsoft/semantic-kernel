...
class NetworkingV1beta1IngressTLS(object):
  ...
  """
    Attributes:
      ...
      attribute_map (dict): The key is attribute name and the value is json key
        in definition.
  """
  swagger_types = {'hosts': 'list[str]', 'secret_name': 'str'}

  attribute_map = {'hosts': 'hosts', 'secret_name': 'secretName'}

  def __init__(self, hosts=None, secret_name=None):
    """
        NetworkingV1beta1IngressTLS - a model defined in Swagger
        """
  ...
  def hosts(self):
    """
        Gets the hosts of this NetworkingV1beta1IngressTLS.
  ...
  def secret_name(self):
    """
        Gets the secret_name of this NetworkingV1beta1IngressTLS.
  ...
  def secret_name(self, secret_name):
    """
        ...
        :param secret_name: The secret_name of this NetworkingV1beta1IngressTLS.
        :type: str
        """
