...
class PolicyV1beta1RunAsGroupStrategyOptions(object):
  ...
  """
    Attributes:
      ...
      attribute_map (dict): The key is attribute name and the value is json key
        in definition.
  """
  swagger_types = {'ranges': 'list[PolicyV1beta1IDRange]', 'rule': 'str'}

  attribute_map = {'ranges': 'ranges', 'rule': 'rule'}

  def __init__(self, ranges=None, rule=None):
    """
        PolicyV1beta1RunAsGroupStrategyOptions - a model defined in Swagger
        """
  ...
  def ranges(self):
    """
        Gets the ranges of this PolicyV1beta1RunAsGroupStrategyOptions.
        ...
        :return: The ranges of this PolicyV1beta1RunAsGroupStrategyOptions.
  ...
  def rule(self):
    """
        Gets the rule of this PolicyV1beta1RunAsGroupStrategyOptions.
        rule is the strategy that will dictate the allowable RunAsGroup values
        that may be set.

        :return: The rule of this PolicyV1beta1RunAsGroupStrategyOptions.
        :rtype: str
        """
    return self._rule
  ...
  def rule(self, rule):
    """
        ...
        :param rule: The rule of this PolicyV1beta1RunAsGroupStrategyOptions.
        :type: str
        """
    if rule is None:
