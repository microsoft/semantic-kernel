...
class V1VolumeAttachmentList(object):
  ...
  def __init__(self, api_version=None, items=None, kind=None, metadata=None):
    """
        V1VolumeAttachmentList - a model defined in Swagger
        """
  ...
  def api_version(self):
    """
        Gets the api_version of this V1VolumeAttachmentList.
        APIVersion defines the versioned schema of this representation of an
        object. Servers should convert recognized schemas to the latest internal
        value, and may reject unrecognized values. More info:
        https://git.k8s.io/community/contributors/devel/api-conventions.md#resources

        :return: The api_version of this V1VolumeAttachmentList.
        :rtype: str
        """
  ...
  def api_version(self, api_version):
    """
        ...
        :param api_version: The api_version of this V1VolumeAttachmentList.
        :type: str
        """
  ...
  def items(self):
    """
        Gets the items of this V1VolumeAttachmentList.
  ...
  def kind(self):
    """
        Gets the kind of this V1VolumeAttachmentList.
  ...
  def metadata(self):
    """
        Gets the metadata of this V1VolumeAttachmentList.
  ...
  def metadata(self, metadata):
    """
        ...
        :param metadata: The metadata of this V1VolumeAttachmentList.
        :type: V1ListMeta
        """
