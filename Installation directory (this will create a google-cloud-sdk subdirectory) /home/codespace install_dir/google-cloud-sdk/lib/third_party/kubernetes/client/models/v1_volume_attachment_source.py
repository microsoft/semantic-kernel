...
class V1VolumeAttachmentSource(object):
  ...
  """
    Attributes:
      ...
      attribute_map (dict): The key is attribute name and the value is json key
        in definition.
  """
  swagger_types = {'persistent_volume_name': 'str'}

  attribute_map = {'persistent_volume_name': 'persistentVolumeName'}

  def __init__(self, persistent_volume_name=None):
    """
        V1VolumeAttachmentSource - a model defined in Swagger
        """
  ...
  def persistent_volume_name(self):
    """
        Gets the persistent_volume_name of this V1VolumeAttachmentSource.
        Name of the persistent volume to attach.

        :return: The persistent_volume_name of this V1VolumeAttachmentSource.
        :rtype: str
        """
