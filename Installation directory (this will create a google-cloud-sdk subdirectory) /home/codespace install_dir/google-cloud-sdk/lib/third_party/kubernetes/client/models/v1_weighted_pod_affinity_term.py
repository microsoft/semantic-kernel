...
class V1WeightedPodAffinityTerm(object):
  ...
  """
    Attributes:
      ...
      attribute_map (dict): The key is attribute name and the value is json key
        in definition.
  """
  swagger_types = {'pod_affinity_term': 'V1PodAffinityTerm', 'weight': 'int'}

  attribute_map = {'pod_affinity_term': 'podAffinityTerm', 'weight': 'weight'}
  ...
  def pod_affinity_term(self, pod_affinity_term):
    ...
    if pod_affinity_term is None:
      raise ValueError(
          'Invalid value for `pod_affinity_term`, must not be `None`')
