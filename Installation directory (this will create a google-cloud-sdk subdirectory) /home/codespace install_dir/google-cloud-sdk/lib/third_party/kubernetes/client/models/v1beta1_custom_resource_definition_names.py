...
class V1beta1CustomResourceDefinitionNames(object):
  ...
  def categories(self, categories):
    """
        ...
        :param categories: The categories of this
  ...
  def plural(self):
    """
        ...
        Plural is the plural name of the resource to serve.  It must match the
        name of the CustomResourceDefinition-registration too: plural.group and
