...
class V1beta1SelfSubjectAccessReviewSpec(object):
  ...
  def non_resource_attributes(self, non_resource_attributes):
    """
        Sets the non_resource_attributes of this
        V1beta1SelfSubjectAccessReviewSpec.
        NonResourceAttributes describes information for a non-resource access
        request

        :param non_resource_attributes: The non_resource_attributes of this
        V1beta1SelfSubjectAccessReviewSpec.
  ...
  def resource_attributes(self):
    """
        ...
        :return: The resource_attributes of this
        V1beta1SelfSubjectAccessReviewSpec.
