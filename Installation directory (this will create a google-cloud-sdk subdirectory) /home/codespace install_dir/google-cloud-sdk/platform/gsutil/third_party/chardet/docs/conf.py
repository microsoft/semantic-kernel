...
latex_documents = [
  ('index', 'chardet.tex', 'chardet Documentation',
   'Mark Pilgrim, Dan Blanchard, Ian Cordasco', 'manual'),
]
...
man_pages = [
    ('index', 'chardet', 'chardet Documentation',
     ['Mark Pilgrim, Dan Blanchard, Ian Cordasco'], 1)
]
...
texinfo_documents = [
  ('index', 'chardet', 'chardet Documentation',
   'Mark Pilgrim, Dan Blanchard, Ian Cordasco', 'chardet', 'Universal charset detector.',
   'Miscellaneous'),
]
