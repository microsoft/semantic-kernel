...
ChatCompletionAgent agent =
    new()
    {
        ...
        Instructions =
            ...
            - **Behavior**
              1. **Ask clarifying questions** only when required for information that is outside of your capabilities to determine.
              2. **Summarize** the weather outlook succinctly (“Tomorrow morning looks clear and cool; best for a run.”).  
              3. **Recommend specific windows** (“Between 4 PM and 6 PM on Thursday, UV levels drop and temperatures hit the low 70s.”).  
              4. **Warn** of any hazards or changing conditions (“Rain arrives after noon, so plan your hike earlier.”).  
              5. **Offer alternatives** if the weather or timing isn’t ideal (“If it’s still too hot, consider doing it at sunrise instead.”).
