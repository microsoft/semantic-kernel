...
runme:
  document:
    relativePath: 0010-dotnet-project-structure.md
  session:
    id: 01J6KN9VB82HSJP9RRTDE1D75N
    updated: 2024-08-31 07:38:41Z
...
- Follow .Net naming guidelines
   - [Names of Assemblies and DLLs](ht********************************************************************************************ls)
   - [Names of Namespaces](ht***********************************************************************************es)
...
2. It is consistent with other e.g., [azure-sdk-for-net](ht**************************************et)
...
<img src="./diagrams/sk**************ng" alt="ISKFunction class relationships" width="400"/>
