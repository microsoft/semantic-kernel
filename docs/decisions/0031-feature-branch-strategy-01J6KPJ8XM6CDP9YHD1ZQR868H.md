...
runme:
  document:
    relativePath: 0031-feature-branch-strategy.md
  session:
    id: 01J6KPJ8XM6CDP9YHD1ZQR868H
    updated: 2024-08-31 07:58:30Z
status: approved
---
...
{Project GUID}.Publish|Any CP*******.0 = Publish|Any CPU
```
...
| Number of Models      | [61](ht*********************ry) +Any GGUF converted | [25](ht*********************************************************ls) +Any GGUF Converted |

| Model Support   | Ollama | LM Studio |
| --------------- | ------ | --------- |
| Phi-2 Support   | Yes    | Yes       |
| Ll***-2 Support | Yes    | Yes       |
...
| Ll***-2    | Yes           | Azure, LM Studio, HuggingFace, Ollama  | HuggingFace, Azure+OpenAI, LM Studio\*\*\*, Ollama\*\* |
