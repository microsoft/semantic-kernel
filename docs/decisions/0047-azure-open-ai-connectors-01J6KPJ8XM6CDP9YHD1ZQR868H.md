...
runme:
  document:
    relativePath: 0047-azure-open-ai-connectors.md
  session:
    id: 01J6KPJ8XM6CDP9YHD1ZQR868H
    updated: 2024-08-31 07:58:14Z
status: approved
---
...
graph TD
    A[SemanticKernel.Connectors.OpenAI] --> B[OpenAI 2.******ta.*]
    A --> C[Azure.OpenAI 1.*********17]
    D[SemanticKernel.Connectors.AzureOpenAI] --> E[Azure.AI.OpenAI 2.******ta.*]
```
