...
var summarize = kernel.CreateSemanticFunction(prompt, executionSettings: new OpenAIRequestSettings { MaxTokens = 100 });
...
var translator = kernel.CreateSemanticFunction(translationPrompt, executionSettings: new OpenAIRequestSettings { MaxTokens = 200 });
var summarize = kernel.CreateSemanticFunction(summarizePrompt, executionSettings: new OpenAIRequestSettings { MaxTokens = 100 });
