...
public class Divide
{
    ...
    {
        this._logger = loggerFactory.CreateLogger<Divide>();
    }
    ...
    public HttpResponseData Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post")] HttpRequestData req)
    {
        ...
        if (result1 && result2 && divisor != 0)
        {
            ...
            this._logger.LogInformation($"Divide function executed successfully. Dividend: {dividend}, Divisor: {divisor}, Quotient: {quotient}");
