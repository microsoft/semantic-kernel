...
/// </remarks>
public class Google_Gemini_StructuredOutputs(ITestOutputHelper output) : BaseTest(output)
{
    /// <summary>
    ...
    {
        Console.WriteLine("============= Vertex AI - Gemini Chat Completion Structured Outputs =============");
