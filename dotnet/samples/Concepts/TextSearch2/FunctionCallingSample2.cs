...
/// </summary>
public sealed class FunctionCallingExample2(ITestOutputHelper output) : BaseTest(output)
{
    /// <summary>
    ...
    /// </summary>
    [Fact]
    public async Task FunctionCallingWithBingTextSearch2Async()
    {
    ...
    /// </summary>
    [Fact]
    public async Task FunctionCallingWithBingTextSearch2IncludeLinksAsync()
    {
        // Create a logging handler to output HTTP requests and responses
        LoggingHandler handler = new(new HttpClientHandler(), this.Output);
        HttpClient httpClient = new(handler);
    ...
    /// </summary>
    [Fact]
    public async Task FunctionCallingWithBingTextSearch2UseDevBlogsSiteAsync()
    {
        // Create a logging handler to output HTTP requests and responses
        LoggingHandler handler = new(new HttpClientHandler(), this.Output);
        HttpClient httpClient = new(handler);
    ...
    private static KernelPluginFromTextSearchOptions CreateCustomOptions(BingTextSearch2 textSearch)
    {
