...
public static class Program
{
    ...
    {
        // Don't add vector store if no collection name is provided. Allows for basic experience where no data is upload to the vector store yet.
    ...
    {
        // Register agent without RAG if no collection name is provided. Allows for basic experience where no data is upload to the vector store yet.
