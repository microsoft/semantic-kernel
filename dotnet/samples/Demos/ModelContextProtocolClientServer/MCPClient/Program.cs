...
internal sealed class Program
{
    public static async Task Main(string[] args)
    {
        ...
        await UseAgentAvailableAsMCPToolAsync();
    }
    ...
    /// </summary>
    private static async Task UseAgentAvailableAsMCPToolAsync()
    {
        Console.WriteLine($"Running the {nameof(UseAgentAvailableAsMCPToolAsync)} sample.");
