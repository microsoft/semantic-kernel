...
/**
 * @generated from protobuf message ProcessWithCloudEvents.Grpc.Contract.FeatureDocumentationRequest
 */
...
/**
 * @generated from protobuf message ProcessWithCloudEvents.Grpc.Contract.DocumentationContentRequest
 */
export interface DocumentationContentRequest {
    ...
    /**
     * @generated from protobuf field: ProcessWithCloudEvents.Grpc.Contract.ProcessData processData = 10;
     */
    processData?: ProcessData;
}
/**
 * @generated from protobuf message ProcessWithCloudEvents.Grpc.Contract.DocumentationApprovalRequest
 */
...
/**
 * @generated from protobuf message ProcessWithCloudEvents.Grpc.Contract.ProcessData
 */
...
/**
 * @generated from protobuf message ProcessWithCloudEvents.Grpc.Contract.Empty
 */
...
class FeatureDocumentationRequest$Type extends MessageType<FeatureDocumentationRequest> {
    constructor() {
        super("ProcessWithCloudEvents.Grpc.Contract.FeatureDocumentationRequest", [
...
/**
 * @generated MessageType for protobuf message ProcessWithCloudEvents.Grpc.Contract.FeatureDocumentationRequest
 */
...
class DocumentationContentRequest$Type extends MessageType<DocumentationContentRequest> {
    constructor() {
        super("ProcessWithCloudEvents.Grpc.Contract.DocumentationContentRequest", [
            { no: 1, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string assistantMessage */ 3:
                    ...
                    break;
                case /* ProcessWithCloudEvents.Grpc.Contract.ProcessData processData */ 10:
    ...
    internalBinaryWrite(message: DocumentationContentRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* ProcessWithCloudEvents.Grpc.Contract.ProcessData processData = 10; */
...
/**
 * @generated MessageType for protobuf message ProcessWithCloudEvents.Grpc.Contract.DocumentationContentRequest
 */
...
class DocumentationApprovalRequest$Type extends MessageType<DocumentationApprovalRequest> {
    constructor() {
        super("ProcessWithCloudEvents.Grpc.Contract.DocumentationApprovalRequest", [
...
/**
 * @generated MessageType for protobuf message ProcessWithCloudEvents.Grpc.Contract.DocumentationApprovalRequest
 */
...
class ProcessData$Type extends MessageType<ProcessData> {
    constructor() {
        super("ProcessWithCloudEvents.Grpc.Contract.ProcessData", [
...
/**
 * @generated MessageType for protobuf message ProcessWithCloudEvents.Grpc.Contract.ProcessData
 */
export const ProcessData = new ProcessData$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Empty$Type extends MessageType<Empty> {
    constructor() {
        super("ProcessWithCloudEvents.Grpc.Contract.Empty", []);
    }
...
/**
 * @generated MessageType for protobuf message ProcessWithCloudEvents.Grpc.Contract.Empty
 */
export const Empty = new Empty$Type();
/**
 * @generated ServiceType for protobuf service ProcessWithCloudEvents.Grpc.Contract.GrpcDocumentationGeneration
 */
export const GrpcDocumentationGeneration = new ServiceType("ProcessWithCloudEvents.Grpc.Contract.GrpcDocumentationGeneration", [
