...
public class DocumentGenerationService : GrpcDocumentationGeneration.GrpcDocumentationGenerationBase
{
    ...
    public override async Task<ProcessData> UserRequestFeatureDocumentation(FeatureDocumentationRequest request, ServerCallContext context)
    {
        ...
        var processContext = await LocalKernelProcessFactory.StartAsync(this._kernel, this._registeredProcesses, DocumentGenerationProcess.Key, processId, new KernelProcessEvent()
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
    ...
    public override async Task<Empty> UserReviewedDocumentation(DocumentationApprovalRequest request, ServerCallContext context)
    {
        ...
        var processContext = await LocalKernelProcessFactory.StartAsync(this._kernel, this._registeredProcesses, DocumentGenerationProcess.Key, request.ProcessData.ProcessId, processEvent, externalMessageChannel: this._externalMessageChannel, storageConnector: this._storageConnector);
