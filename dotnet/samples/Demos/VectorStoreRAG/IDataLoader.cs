...
internal interface IDataLoader
{
    ...
    /// <param name="maxDegreeOfParallelism">Maximum number of parallel threads to generate embeddings and upload records.</param>
    ...
    Task LoadPdf(string pdfPath, int maxDegreeOfParallelism, int betweenBatchDelayInMs, CancellationToken cancellationToken);
}
