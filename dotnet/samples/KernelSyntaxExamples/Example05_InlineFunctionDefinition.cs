...
";
        ...
        var excuseFunction = kernel.CreateSemanticFunction(FunctionDefinition, requestSettings: new { MaxTokens = 100, Temperature = 0.4, TopP = 1 });
        ...
        var fixedFunction = kernel.CreateSemanticFunction($"Translate this date {DateTimeOffset.Now:f} to French format", requestSettings: new { MaxTokens = 100 });
