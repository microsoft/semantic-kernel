...
public class Example09_FunctionTypes : BaseTest
{
    ...
    {
        this._output.WriteLine("======== Method Function types ========");
        ...
        LocalExamplePlugin.Output = this._output;
...
public class LocalExamplePlugin
{
    ...
    {
        Output.WriteLine($"Running {nameof(this.NoInputWithVoidResult)} -> No input");
    }
    ...
    {
        Output.WriteLine($"Running {nameof(this.NoInputTaskWithVoidResult)} -> No input");
    ...
    public string InputDateTimeWithStringResult(DateTime currentDate)
    {
        ...
        Output.WriteLine($"Running {nameof(this.InputDateTimeWithStringResult)} -> [currentDate = {currentDate}] -> result: {result}");
        return result;
    }
    ...
    public Task<string> NoInputTaskWithStringResult()
    {
        ...
        Output.WriteLine($"Running {nameof(this.NoInputTaskWithStringResult)} -> No input -> result: {result}");
    ...
    {
        Output.WriteLine($"Running {nameof(this.MultipleInputsWithVoidResult)} -> input: [x = {x}, y = {y}, z = {z}]");
    }
    ...
    public string ComplexInputWithStringResult(object complexObject)
    {
        ...
        Output.WriteLine($"Running {nameof(this.ComplexInputWithStringResult)} -> input: [complexObject = {complexObject}] -> result: {result}");
        return result;
    }
    ...
    {
        Output.WriteLine($"Running {nameof(this.InputStringTaskWithStringResult)} -> input: [echoInput = {echoInput}] -> result: {echoInput}");
    ...
    {
        Output.WriteLine($"Running {nameof(this.InputStringTaskWithVoidResult)} -> input: [x = {x}]");
        return Task.CompletedTask;
    }
    ...
    public FunctionResult NoInputWithFunctionResult()
    {
        ...
        Output.WriteLine($"Running {nameof(this.NoInputWithFunctionResult)} -> No input -> result: {result.GetType().Name}");
        return result;
    }
    ...
    public async Task<FunctionResult> NoInputTaskWithFunctionResult(Kernel kernel)
    {
        ...
        Output.WriteLine($"Running {nameof(this.NoInputTaskWithFunctionResult)} -> Injected kernel -> result: {result.GetType().Name}");
        return result;
    }
    ...
    public async Task<string> TaskInjectingKernelWithInputTextAndStringResult(Kernel kernel, string textToSummarize)
    {
        ...
        Output.WriteLine($"Running {nameof(this.TaskInjectingKernelWithInputTextAndStringResult)} -> Injected kernel + input: [textToSummarize: {textToSummarize[..15]}...{textToSummarize[^15..]}] -> result: {summary}");
        return summary!;
    }
    ...
    public async Task<string> TaskInjectingKernelFunctionWithStringResult(KernelFunction executingFunction)
    {
        ...
        Output.WriteLine($"Running {nameof(this.TaskInjectingKernelWithInputTextAndStringResult)} -> Injected Function -> result: {result}");
        return result;
    }
    ...
    public Task TaskInjectingLoggerWithNoResult(ILogger logger)
    {
        ...
        Output.WriteLine($"Running {nameof(this.TaskInjectingKernelWithInputTextAndStringResult)} -> Injected Logger");
        return Task.CompletedTask;
    }
    ...
    public async Task<string> TaskInjectingServiceSelectorWithStringResult(Kernel kernel, KernelFunction function, KernelArguments arguments, IAIServiceSelector serviceSelector)
    {
        ...
        Output.WriteLine($"Running {nameof(this.TaskInjectingKernelWithInputTextAndStringResult)} -> Injected Kernel, KernelFunction, KernelArguments, Service Selector -> result: {result}");
    ...
    public async Task<string> TaskInjectingCultureInfoOrIFormatProviderWithStringResult(CultureInfo cultureInfo, IFormatProvider formatProvider)
    {
        ...
        Output.WriteLine($"Running {nameof(this.TaskInjectingCultureInfoOrIFormatProviderWithStringResult)} -> Injected CultureInfo, IFormatProvider -> result: {result}");
        return result;
    }
    ...
    public async Task<string> TaskInjectingCancellationTokenWithStringResult(CancellationToken cancellationToken)
    {
        ...
        Output.WriteLine($"Running {nameof(this.TaskInjectingCultureInfoOrIFormatProviderWithStringResult)} -> Injected Cancellation Token -> result: {result}");
        return result;
    }
