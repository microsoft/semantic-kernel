...
";
    ...
    private static async Task ConversationSummaryPluginAsync()
    {
        ...
        ReadOnlyKernelPlugin conversationSummaryPlugin = kernel.ImportPluginFromType<ConversationSummaryPlugin>();
    ...
    private static async Task GetConversationActionItemsAsync()
    {
        ...
        ReadOnlyKernelPlugin conversationSummary = kernel.ImportPluginFromType<ConversationSummaryPlugin>();
