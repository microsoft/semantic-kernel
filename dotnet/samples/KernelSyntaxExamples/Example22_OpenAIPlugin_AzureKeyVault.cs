...
public static class Example22_OpenAIPlugin_AzureKeyVault
{
    ...
    public static async Task AddSecretToAzureKeyVaultAsync(Kernel kernel, ReadOnlyKernelPlugin plugin)
    {
    ...
    public static async Task GetSecretFromAzureKeyVaultWithRetryAsync(Kernel kernel, ReadOnlyKernelPlugin plugin)
    {
        // Add arguments for required parameters, arguments for optional ones can be skipped.
        var arguments = new KernelArguments();
