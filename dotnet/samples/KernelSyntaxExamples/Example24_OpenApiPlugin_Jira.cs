...
public static class Example24_OpenApiPlugin_Jira
{
    public static async Task RunAsync()
    {
        ...
        if (useLocalFile)
        {
            ...
            jiraFunctions = await kernel.ImportOpenApiPluginFunctionsAsync("jiraPlugin", apiPluginFile, new OpenApiPluginFunctionExecutionParameters(authCallback: tokenProvider.AuthenticateRequestAsync));
        }
        else
        {
            ...
            jiraFunctions = await kernel.ImportOpenApiPluginFunctionsAsync("jiraPlugin", apiPluginRawFileURL, new OpenApiPluginFunctionExecutionParameters(httpClient, tokenProvider.AuthenticateRequestAsync));
        }
