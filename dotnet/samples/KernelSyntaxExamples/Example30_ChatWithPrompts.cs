...
public static class Example30_ChatWithPrompts
{
    public static async Task RunAsync()
    {
        ...
        string systemMessage = await promptTemplateFactory.Create(systemPromptTemplate, new PromptTemplateConfig()).RenderAsync(kernel, arguments);
        Console.WriteLine($"------------------------------------\n{systemMessage}");
        ...
        string userMessage = await promptTemplateFactory.Create(userPromptTemplate, new PromptTemplateConfig()).RenderAsync(kernel, arguments);
        Console.WriteLine($"------------------------------------\n{userMessage}");
