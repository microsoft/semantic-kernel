...
public static class Example42_KernelBuilder
{
    public static Task RunAsync()
    {
        ...
        services.AddSingleton<KernelPluginBase>(sp => KernelPluginFactory.CreateFromType<TimePlugin>(serviceProvider: sp));
        services.AddSingleton<KernelPluginBase>(sp => KernelPluginFactory.CreateFromType<HttpPlugin>(serviceProvider: sp));
