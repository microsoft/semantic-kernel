...
public static class Example42_KernelBuilder
{
    public static Task RunAsync()
    {
        ...
        services.AddSingleton<ReadOnlyKernelPlugin>(sp => KernelPluginFactory.CreateFromType<TimePlugin>(serviceProvider: sp));
        services.AddSingleton<ReadOnlyKernelPlugin>(sp => KernelPluginFactory.CreateFromType<HttpPlugin>(serviceProvider: sp));
