...
/// OR
///
/// 1. Start the LocalAI Message API Server on http://localhost:8080 using docker
/// 2. docker run -ti -p 8080:8080 localai/localai:v2.12.1-ffmpeg-core phi-2 <see href="https://localai.io/docs/getting-started/run-other-models/" />
...
public class Example88_CustomMessageAPIEndpoint : BaseTest
{
    ...
    [InlineData("LocalAI - Phi2", "http://localhost:8080", "phi-2")] // Start the LocalAI Message API Server on http://localhost:8080 using docker
