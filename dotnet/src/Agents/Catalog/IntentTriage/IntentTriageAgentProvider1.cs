...
/// <summary>
/// Provider to create a <see cref="IntentTriageAgent1"/> instance and
/// its associated <see cref="AgentThread"/>.
/// </summary>
public class IntentTriageAgentProvider1(IConfiguration configuration, ILoggerFactory loggerFactory)
