...
public sealed class ChatCompletionAgentFactory : KernelAgentFactory
{
    ...
    /// <inheritdoc/>
    public override Task<KernelAgent?> TryCreateAsync(Kernel kernel, AgentDefinition agentDefinition, AgentCreationOptions? agentCreationOptions = null, CancellationToken cancellationToken = default)
    {
