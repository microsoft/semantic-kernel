...
internal static class AssistantThreadActions
{
    ...
    /// <param name="threadExtensionsContext">Additional context from thead extensions to pass to the invoke method.</param>
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        RunCreationOptions options = AssistantRunOptionsFactory.GenerateOptions(agent.RunOptions, instructions, invocationOptions, threadExtensionsContext);
