...
internal static class AssistantThreadActions
{
    ...
    /// <param name="providersContext">Additional context from <see cref="AIContextProvider"/> instances to pass to the invoke method.</param>
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        RunCreationOptions options = AssistantRunOptionsFactory.GenerateOptions(agent.RunOptions, instructions, invocationOptions, providersContext);
