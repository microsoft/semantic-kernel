...
//    {
//        /// <summary>
//        /// The chat message captures the final result.
//        /// </summary>
//        public ChatMessageContent Message { get; init; } = Empty;
//    }
...
//    /// <summary>
//    /// The input task for a <see cref="ChatManager"/>.
//    /// </summary>
...
//    /// Extension method to convert a <see cref="ChatMessageContent"/> to a <see cref="Result"/>.
//    /// </summary>
//    public static InputTask ToTask(this ChatMessageContent message) => new() { Message = message };
//}
