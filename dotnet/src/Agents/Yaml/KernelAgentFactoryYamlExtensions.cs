...
public static class KernelAgentFactoryYamlExtensions
{
    ...
    public static async Task<Agent?> CreateAgentFromYamlAsync(this AgentFactory kernelAgentFactory, string text, Kernel? kernel = null, IPromptTemplateFactory? promptTemplateFactory = null, CancellationToken cancellationToken = default)
    {
