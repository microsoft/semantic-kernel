...
public abstract class ClientBase
{
    ...
    private protected async Task<IReadOnlyList<ITextResult>> InternalCompleteTextAsync(
        string text,
    ...
    private protected async IAsyncEnumerable<TextStreamingResult> InternalCompletionStreamAsync(
        string text,
        CompleteRequestSettings requestSettings,
    ...
    private protected List<ITextStreamingResult> InternalGetTextCompletionAsChat(string text, CompleteRequestSettings requestSettings, CancellationToken cancellationToken)
    {
