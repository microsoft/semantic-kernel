...
public abstract class ClientBase
{
    ...
    /// <summary>
    /// Gets raw text completions stream for the prompt and settings.
    /// </summary>
    /// <param name="text">The prompt to complete.</param>
    /// <param name="requestSettings">Request settings for the completion API</param>
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> to monitor for cancellation requests. The default is <see cref="CancellationToken.None"/>.</param>
    /// <returns>Stream the raw completions generated by the remote model</returns>
    private protected async Task<Stream> InternalGetRawTextCompletionsStreamAsync(
        string text,
        CompleteRequestSettings requestSettings,
        CancellationToken cancellationToken = default)
    {
        ...
        return response.GetRawResponse()?.ContentStream
            ?? throw new SKException("Text completions null response");
    }

    /// <summary>
    /// Gets raw chat completions stream for the prompt and settings.
    /// </summary>
    ...
    private protected async Task<Stream> InternalGetRawChatCompletionsStreamAsync(
