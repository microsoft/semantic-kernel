...
public abstract class ClientBase
{
    ...
    private protected async Task<string> InternalCompleteTextAsync(
        string text,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (requestSettings.ResultsPerPrompt > 1)
        {
            throw new KernelException(
                ...
                $"ResultsPerPrompt results not supported.");
        }
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> to monitor for cancellation requests. The default is <see cref="CancellationToken.None"/>.</param>
    /// <returns>Text generated by the remote model</returns>
    private protected async Task<IReadOnlyList<ITextCompletionResult>> InternalCompleteTextMultiAsync(
        string text,
        CompleteRequestSettings requestSettings,
        CancellationToken cancellationToken = default)
    {
        ...
        return response.Value.Choices.Select(choice => new TextCompletionResultBase(choice)).ToList();
    }
    ...
    private protected async IAsyncEnumerable<string> InternalCompletionStreamAsync(
        string text,
        CompleteRequestSettings requestSettings,
    ...
    private protected async IAsyncEnumerable<TextCompletionStreamingResultBase> InternalMultiCompletionStreamAsync(
        string text,
        CompleteRequestSettings requestSettings,
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        await foreach (StreamingChoice choice in streamingChatCompletions.GetChoicesStreaming(cancellationToken))
        {
            yield return new TextCompletionStreamingResultBase(choice);
        }
    }
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> to monitor for cancellation requests. The default is <see cref="CancellationToken.None"/>.</param>
    /// <returns>Text generated by the remote model</returns>
    private protected async Task<string> InternalCompleteTextUsingChatAsync(
        string text,
        CompleteRequestSettings requestSettings,
        CancellationToken cancellationToken = default)
    {
    ...
    private protected IAsyncEnumerable<string> InternalCompleteTextUsingChatStreamAsync(
        string text,
        CompleteRequestSettings requestSettings,
        CancellationToken cancellationToken = default)
    {
