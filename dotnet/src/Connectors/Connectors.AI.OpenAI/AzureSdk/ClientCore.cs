...
internal abstract class ClientCore
{
    ...
    internal async Task<IReadOnlyList<ITextResult>> GetTextResultsAsync(
        string text,
    ...
    internal async Task<IReadOnlyList<IChatResult>> GetChatResultsAsync(
        ChatHistory chat,
        PromptExecutionSettings? executionSettings,
        CancellationToken cancellationToken = default)
    {
    ...
    internal async IAsyncEnumerable<T> GetChatStreamingUpdatesAsync<T>(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return (await this.GetChatResultsAsync(chat, chatSettings, cancellationToken).ConfigureAwait(false))
            .OfType<ITextResult>()
            .ToList();
    }
