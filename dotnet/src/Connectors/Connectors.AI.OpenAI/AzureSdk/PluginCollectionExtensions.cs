...
{
    /// <summary>
    /// Given an <see cref="OpenAIFunctionResponse"/> object, tries to retrieve the corresponding <see cref="SKFunction"/> and populate <see cref="ContextVariables"/> with its parameters.
    /// </summary>
    ...
    public static bool TryGetFunctionAndContext(
        ...
        [NotNullWhen(true)] out SKFunction? availableFunction,
