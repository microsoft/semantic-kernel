...
public class StreamingTextModelResult
{
    ...
    /// </summary>
    public StreamingChoice Choice { get; }

    /// <summary> Initializes a new instance of StreamingTextModelResult. </summary>
    ...
    internal StreamingTextModelResult(StreamingCompletions completionsData, StreamingChoice choiceData)
    {
