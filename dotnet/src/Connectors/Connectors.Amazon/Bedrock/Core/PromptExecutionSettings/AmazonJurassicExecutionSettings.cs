...
public class AmazonJurassicExecutionSettings : PromptExecutionSettings
{
    ...
    private AI21JurassicRequest.CountPenalty? _countPenalty;
    private AI21JurassicRequest.PresencePenalty? _presencePenalty;
    private AI21JurassicRequest.FrequencyPenalty? _frequencyPenalty;
    ...
    public AI21JurassicRequest.CountPenalty? CountPenalty
    {
    ...
    public AI21JurassicRequest.PresencePenalty? PresencePenalty
    {
    ...
    public AI21JurassicRequest.FrequencyPenalty? FrequencyPenalty
    {
