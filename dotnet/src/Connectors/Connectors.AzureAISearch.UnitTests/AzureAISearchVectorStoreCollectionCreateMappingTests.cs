...
public class AzureAISearchVectorStoreCollectionCreateMappingTests
{
    ...
    {
        // Arrange
        var keyProperty = new VectorStoreKeyPropertyModel("testkey", typeof(string)) { StorageName = "test_key" };
    ...
    {
        // Arrange
        var dataProperty = new VectorStoreDataPropertyModel("testdata", typeof(string))
        {
    ...
    {
        // Arrange
        var dataProperty = new VectorStoreDataPropertyModel("testdata", typeof(int))
        {
            IsFullTextIndexed = true,
            StorageName = "test_data"
        };
    ...
    {
        // Arrange
        var vectorProperty = new VectorStoreVectorPropertyModel("testvector", typeof(ReadOnlyMemory<float>))
        {
            Dimensions = 10,
    ...
    {
        // Arrange
        var vectorProperty = new VectorStoreVectorPropertyModel("testvector", typeof(ReadOnlyMemory<float>)) { Dimensions = 10 };
