...
/// <summary>
/// Unit tests for <see cref="Microsoft.SemanticKernel.Connectors.AzureCosmosDBNoSQL.CosmosNoSqlCollectionQueryBuilder"/> class.
/// </summary>
public sealed class CosmosNoSqlCollectionQueryBuilderTests
{
    ...
    public void BuildSearchQueryByDefaultReturnsValidQueryDefinition()
    {
        ...
        // Act
        var queryDefinition = Microsoft.SemanticKernel.Connectors.AzureCosmosDBNoSQL.CosmosNoSqlCollectionQueryBuilder.BuildSearchQuery<ReadOnlyMemory<float>, DummyType>(
            vector,
            keywords: null,
            this._model,
            vectorPropertyName,
    ...
    public void BuildSearchQueryWithInvalidFilterThrowsException()
    {
        ...
        Assert.Throws<InvalidOperationException>(() =>
            Microsoft.SemanticKernel.Connectors.AzureCosmosDBNoSQL.CosmosNoSqlCollectionQueryBuilder.BuildSearchQuery<ReadOnlyMemory<float>, DummyType>(
                vector,
                keywords: null,
                this._model,
                vectorPropertyName,
    ...
    public void BuildSelectQueryByDefaultReturnsValidQueryDefinition()
    {
        ...
        // Act
        var queryDefinition = Microsoft.SemanticKernel.Connectors.AzureCosmosDBNoSQL.CosmosNoSqlCollectionQueryBuilder.BuildSelectQuery(
            model,
