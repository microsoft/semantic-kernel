...
internal partial class ClientCore
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (data.Count > 0)
        {
            ...
            var response = await RunRequestAsync(() => this.Client.GetEmbeddingClient(this.DeploymentName).GenerateEmbeddingsAsync(data, embeddingsOptions, cancellationToken)).ConfigureAwait(false);
