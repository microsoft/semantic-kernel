...
internal partial class ClientCore
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        ClientResult<GeneratedImage> response = await RunRequestAsync(() => this.Client.GetImageClient(this.DeploymentOrModelId).GenerateImageAsync(prompt, imageOptions, cancellationToken)).ConfigureAwait(false);
