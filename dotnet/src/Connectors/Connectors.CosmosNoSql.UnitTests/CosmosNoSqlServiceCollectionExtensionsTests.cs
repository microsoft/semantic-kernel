...
public sealed class CosmosNoSqlServiceCollectionExtensionsTests
{
    ...
    public void AddVectorStoreRegistersClass()
    {
        ...
        // Act
        this._serviceCollection.AddCosmosNoSqlVectorStore();
        ...
        Assert.IsType<Microsoft.SemanticKernel.Connectors.CosmosNoSql.CosmosNoSqlVectorStore>(vectorStore);
    }
    ...
    {
        // Act
        this._serviceCollection.AddCosmosNoSqlVectorStore("AccountEndpoint=https://test.documents.azure.com:443/;AccountKey=mock;", "mydb");
    ...
    public void AddVectorStoreRecordCollectionRegistersClass()
    {
        ...
        // Act
        this._serviceCollection.AddCosmosNoSqlVectorStoreRecordCollection<TestRecord>("testcollection");
    ...
    {
        // Act
        this._serviceCollection.AddCosmosNoSqlVectorStoreRecordCollection<TestRecord>("testcollection", "AccountEndpoint=https://test.documents.azure.com:443/;AccountKey=mock;", "mydb");
