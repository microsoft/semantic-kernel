...
public sealed class GeminiClientChatStreamingTests : IDisposable
{
    ...
    public async Task ShouldContainRolesInRequestAsync()
    {
        ...
        var client = this.CreateChatCompletionClient(geminiConfiguration);
    ...
    private GeminiChatCompletionClient CreateChatCompletionClient(GeminiConfiguration geminiConfiguration)
    {
