...
internal static class AzureAISearchVectorStoreCollectionCreateMapping
{
    ...
    public static SimpleField MapDataField(VectorStoreRecordDataPropertyModel dataProperty)
    {
        ...
        return new SimpleField(dataProperty.StorageName, AzureAISearchVectorStoreCollectionCreateMapping.GetSDKFieldDataType(dataProperty.ClrType)) { IsFilterable = dataProperty.IsFilterable };
    }
