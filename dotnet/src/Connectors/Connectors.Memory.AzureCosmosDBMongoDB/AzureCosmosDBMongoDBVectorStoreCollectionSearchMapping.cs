...
internal static class AzureCosmosDBMongoDBVectorStoreCollectionSearchMapping
{
    ...
    public static string GetVectorPropertyDistanceFunction(string? distanceFunction) => !string.IsNullOrWhiteSpace(distanceFunction) ? distanceFunction! : DistanceFunction.CosineDistance;
    ...
    public static BsonDocument[] GetHybridSearchPipeline(
