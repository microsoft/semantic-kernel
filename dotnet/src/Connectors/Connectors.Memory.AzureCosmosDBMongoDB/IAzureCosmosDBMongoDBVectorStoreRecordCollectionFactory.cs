...
public interface IAzureCosmosDBMongoDBVectorStoreRecordCollectionFactory
{
    ...
    IVectorStoreRecordCollection<TKey, TRecord> CreateVectorStoreRecordCollection<TKey, TRecord>(IMongoDatabase mongoDatabase, string name, VectorStoreRecordDefinition? vectorStoreRecordDefinition) where TRecord : class;
}
