...
/// </summary>
public class AzureSearchRecord
{
    ...
    /// </summary>
    public AzureSearchRecord()
    {
    }

    public AzureSearchRecord(string id)
    {
        this.Id = EncodeId(id);
    }
    ...
    public static AzureSearchRecord FromMemoryRecord(MemoryRecord record)
    {
        return new AzureSearchRecord(
