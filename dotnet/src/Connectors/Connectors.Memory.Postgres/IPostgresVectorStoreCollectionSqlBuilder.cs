...
internal interface IPostgresVectorStoreCollectionSqlBuilder
{
    ...
    PostgresSqlCommandInfo BuildCreateTableCommand(string schema, string tableName, VectorStoreCollectionModel model, bool ifNotExists = true);
    ...
    /// <returns>The built SQL command info.</returns>
    PostgresSqlCommandInfo BuildGetCommand<TKey>(string schema, string tableName, VectorStoreCollectionModel model, TKey key, bool includeVectors = false) where TKey : notnull;
    ...
    /// <returns>The built SQL command info.</returns>
    PostgresSqlCommandInfo BuildGetBatchCommand<TKey>(string schema, string tableName, VectorStoreCollectionModel model, List<TKey> keys, bool includeVectors = false) where TKey : notnull;
...
#pragma warning disable CS0618 // VectorSearchFilter is obsolete
    PostgresSqlCommandInfo BuildGetNearestMatchCommand<TRecord>(string schema, string tableName, VectorStoreCollectionModel model, VectorStoreVectorPropertyModel vectorProperty, Vector vectorValue, VectorSearchFilter? legacyFilter, Expression<Func<TRecord, bool>>? newFilter, int? skip, bool includeVectors, int limit);
