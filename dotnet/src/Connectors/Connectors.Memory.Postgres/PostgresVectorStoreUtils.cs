...
internal static class PostgresVectorStoreUtils
{
    ...
    /// <param name="vectorStoreSystemName">The name of the vector store system being operated on.</param>
        ...
        string? vectorStoreSystemName = null)
    {
        ...
        var nextResult = await GetNextAsync<T>(enumerator, operationName, collectionName, vectorStoreSystemName).ConfigureAwait(false);
