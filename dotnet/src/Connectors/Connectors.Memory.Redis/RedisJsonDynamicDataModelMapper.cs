...
/// </summary>
internal class RedisJsonDynamicDataModelMapper(VectorStoreCollectionModel model, JsonSerializerOptions jsonSerializerOptions) : IRedisJsonMapper<Dictionary<string, object?>>
{
    /// <inheritdoc />
