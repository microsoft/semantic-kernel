...
internal static class RedisVectorStoreCollectionSearchMapping
{
    ...
    public static Query BuildQuery<TRecord>(byte[] vectorBytes, int top, VectorSearchOptions<TRecord> options, VectorStoreCollectionModel model, VectorStoreVectorPropertyModel vectorProperty, string[]? selectFields)
    {
        // Build search query.
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    internal static Query BuildQuery<TRecord>(Expression<Func<TRecord, bool>> filter, int top, GetFilteredRecordOptions<TRecord> options, VectorStoreCollectionModel model)
    {
...
#pragma warning disable CS0618 // Type or member is obsolete
    public static string BuildLegacyFilter(VectorSearchFilter basicVectorSearchFilter, VectorStoreCollectionModel model)
    {
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    public static string ResolveDistanceFunction(VectorStoreVectorPropertyModel vectorProperty)
