...
#pragma warning restore CA1711 // Identifiers should not have incorrect suffix
{
        ...
        WeaviateVectorStoreRecordCollectionOptions<TRecord>? options = default)
    {
        ...
        this._mapper = typeof(TRecord) == typeof(Dictionary<string, object?>)
            ? (new WeaviateDynamicDataModelMapper(this.Name, this._model, s_jsonSerializerOptions) as IWeaviateMapper<TRecord>)!
            : new WeaviateVectorStoreRecordMapper<TRecord>(this.Name, this._model, s_jsonSerializerOptions);
