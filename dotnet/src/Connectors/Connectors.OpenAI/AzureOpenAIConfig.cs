...
/// </summary>
public sealed class AzureOpenAIConfig : ServiceConfig
{
    /// <summary>
    ...
    public AzureOpenAIConfig(string serviceId, string deploymentName, string endpoint, string apiKey, string apiVersion)
        : base(serviceId)
    {
