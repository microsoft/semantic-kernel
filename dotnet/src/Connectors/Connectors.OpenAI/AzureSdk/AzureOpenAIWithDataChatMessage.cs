...
public sealed class AzureOpenAIWithDataChatMessage : ChatMessage
{
    /// <summary>
    ...
    internal AzureOpenAIWithDataChatMessage(ChatWithDataChoice chatChoice, string? modelId, IDictionary<string, object?>? metadata = null)
