...
public sealed class OpenAIChatMessageContent : ChatMessageContent
{
    ...
    internal OpenAIChatMessageContent(ChatResponseMessage chatMessage, string? name, string modelId, IReadOnlyDictionary<string, object?>? metadata = null)
    ...
    /// Initializes a new instance of the <see cref="OpenAIChatMessageContent"/> class.
    /// </summary>
    internal OpenAIChatMessageContent(ChatRole role, string? content, string? name, string modelId, IReadOnlyList<ChatCompletionsToolCall> toolCalls, IReadOnlyDictionary<string, object?>? metadata = null)
    ...
    /// Initializes a new instance of the <see cref="OpenAIChatMessageContent"/> class.
    /// </summary>
    internal OpenAIChatMessageContent(AuthorRole role, string? content, string? name, string modelId, IReadOnlyList<ChatCompletionsToolCall> toolCalls, IReadOnlyDictionary<string, object?>? metadata = null)
