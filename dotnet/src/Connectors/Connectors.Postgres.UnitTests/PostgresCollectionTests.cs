...
public class PostgresCollectionTests
{
    ...
    public void ThrowsForUnsupportedType()
    {
        ...
        // Act & Assert
        Assert.Throws<NotSupportedException>(() => new PostgresCollection<object, Dictionary<string, object?>>(this._postgresClientMock.Object, TestCollectionName, options));
    }
    ...
    public async Task UpsertRecordAsyncProducesExpectedClientCallAsync()
    {
        ...
        var sut = new PostgresCollection<int, PostgresHotel<int>>(this._postgresClientMock.Object, TestCollectionName);
    ...
    public async Task CollectionExistsReturnsValidResultAsync()
    {
        ...
        var sut = new PostgresCollection<int, TestRecord<int>>(this._postgresClientMock.Object, TableName);
