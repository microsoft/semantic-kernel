...
public sealed class HuggingFaceEmbeddingGenerationTests : IDisposable
{
    ...
    {
        //Arrange
        using var sut = new HuggingFaceTextEmbeddingGeneration("fake-model", "https://fake-random-test-host/fake-path", httpClient: this.httpClient);
    ...
    public async Task HttpClientBaseAddressShouldBeUsedAsync()
    {
        ...
        using var sut = new HuggingFaceTextEmbeddingGeneration("fake-model", httpClient: this.httpClient);
    ...
    {
        //Arrange
        using var sut = new HuggingFaceTextEmbeddingGeneration("fake-model", endpoint: "https://fake-random-test-host/fake-path", httpClient: this.httpClient);
