...
public class QdrantMemoryStoreTests2
{
    ...
    public async Task GetAsyncCallsDoNotRequestVectorsUnlessSpecifiedAsync()
    {
        ...
        // Act
        _ = await vectorStore.GetAsync("test_collection", this._id).ConfigureAwait(false);
        _ = await vectorStore.GetAsync("test_collection", this._id, true).ConfigureAwait(false);
        _ = await vectorStore.GetBatchAsync("test_collection", new List<string> { this._id2 }).ToListAsync().ConfigureAwait(false);
        _ = await vectorStore.GetBatchAsync("test_collection", new List<string> { this._id2 }, true).ToListAsync().ConfigureAwait(false);
        _ = await vectorStore.GetWithPointIdAsync("test_collection", guidString).ConfigureAwait(false);
        _ = await vectorStore.GetWithPointIdAsync("test_collection", guidString, true).ConfigureAwait(false);
        _ = await vectorStore.GetWithPointIdBatchAsync("test_collection", new[] { guidString2 }).ToListAsync().ConfigureAwait(false);
        _ = await vectorStore.GetWithPointIdBatchAsync("test_collection", new[] { guidString2 }, true).ToListAsync().ConfigureAwait(false);
    ...
    public async Task GetAsyncSearchesByMetadataIdReturnsNullIfNotFoundAsync()
    {
        ...
        // Act
        var getResult = await vectorStore.GetAsync("test_collection", this._id, false).ConfigureAwait(false);
    ...
    public async Task GetAsyncSearchesByMetadataIdReturnsMemoryRecordIfFoundAsync()
    {
        ...
        // Act
        var getResult = await vectorStore.GetAsync("test_collection", this._id, true).ConfigureAwait(false);
    ...
    public async Task GetBatchAsyncSearchesByMetadataIdReturnsAllResultsIfAllFoundAsync()
    {
        ...
        // Act
        var getBatchResult = await vectorStore.GetBatchAsync("test_collection", new List<string> { this._id, this._id2, this._id3 }, false).ToListAsync().ConfigureAwait(false);
    ...
    public async Task GetByQdrantPointIdReturnsNullIfNotFoundAsync()
    {
        ...
        // Act
        var getResult = await vectorStore.GetWithPointIdAsync("test_collection", key, false).ConfigureAwait(false);
    ...
    public async Task GetByQdrantPointIdReturnsMemoryRecordIfFoundAsync()
    {
        ...
        // Act
        var getResult = await vectorStore.GetWithPointIdAsync("test_collection", memoryRecord.Key, true).ConfigureAwait(false);
    ...
    public async Task GetBatchByQdrantPointIdsReturnsAllResultsIfFoundAsync()
    {
        ...
        // Act
        var getBatchResult = await vectorStore.GetWithPointIdBatchAsync("test_collection", new List<string> { key, key2, key3 }, false).ToListAsync().ConfigureAwait(false);
    ...
    public async Task ItCanRemoveAVectorUsingMetadataIdAsync()
    {
        ...
        // Act
        await vectorStore.RemoveAsync("test_collection", this._id).ConfigureAwait(false);
    ...
    public async Task ItCanRemoveBatchVectorsUsingMetadataIdAsync()
    {
        ...
        // Act
        await vectorStore.RemoveBatchAsync("test_collection", new[] { this._id, this._id2, this._id3 }).ConfigureAwait(false);
    ...
    public async Task ItCanRemoveAVectorUsingDatabaseKeyAsync()
    {
        ...
        // Act
        await vectorStore.RemoveWithPointIdAsync("test_collection", key).ConfigureAwait(false);
    ...
    public async Task ItCanRemoveBatchVectorsUsingDatabaseKeyAsync()
    {
        ...
        // Act
        await vectorStore.RemoveWithPointIdBatchAsync("test_collection", new[] { key, key2, key3 }).ConfigureAwait(false);
