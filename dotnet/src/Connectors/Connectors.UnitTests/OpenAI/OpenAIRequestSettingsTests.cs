...
public class OpenAIRequestSettingsTests
{
    ...
    [Fact]
    public void ItCreatesExistingOpenAITextRequestSettingsFromAnonymousTypeCamelCase()
    {
        // Arrange
    ...
    [Fact]
    public void ItCreatesExistingOpenAITextRequestSettingsFromAnonymousTypePascalCase()
    {
        // Arrange
        var actualSettings = new
        {
    ...
    [Fact]
    public void ItCreatesExistingOpenAITextRequestSettingsFromJsonCamelCase()
    {
        // Arrange
        var json = @"{
  ""temperature"": 0.7,
  ...
  ""max_tokens"": 128
        ...
        //Assert.Equal(actualSettings.GetProperty("stop_sequences").GetDouble(), requestSettings.StopSequences);
        //Assert.Equal(actualSettings.GetProperty("token_selection_biases").GetDouble(), requestSettings.TokenSelectionBiases);
    ...
    [Fact]
    public void ItCreatesExistingOpenAITextRequestSettingsFromJsonPascalCase()
    {
        // Arrange
        var json = @"{
  ""Temperature"": 0.7,
