...
public class VectorStoreRecordDataPropertyModel(string modelName, Type clrType) : VectorStoreRecordPropertyModel(modelName, clrType)
{
    /// <summary>
    ...
    public override string ToString()
        => $"{this.ModelName} (Data, {this.ClrType.Name})";
}
