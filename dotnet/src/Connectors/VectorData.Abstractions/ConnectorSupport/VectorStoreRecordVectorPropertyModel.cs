...
public class VectorStoreRecordVectorPropertyModel(string modelName, Type clrType) : VectorStoreRecordPropertyModel(modelName, clrType)
{
    /// <summary>
    ...
    public override string ToString()
        => $"{this.ModelName} (Vector, {this.ClrType.Name})";
}
