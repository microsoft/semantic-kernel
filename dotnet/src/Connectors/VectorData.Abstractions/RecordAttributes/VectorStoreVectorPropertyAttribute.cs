...
public sealed class VectorStoreVectorPropertyAttribute : Attribute
{
    /// <summary>
    /// Initializes a new instance of the <see cref="VectorStoreVectorPropertyAttribute"/> class.
    /// </summary>
    [Obsolete("This constructor is obsolete, since Dimensions is now a required parameter.", error: true)]
    public VectorStoreVectorPropertyAttribute()
    {
    }
    ...
    public VectorStoreVectorPropertyAttribute(int Dimensions)
    {
        if (Dimensions <= 0)
        {
    ...
    public VectorStoreVectorPropertyAttribute(int Dimensions, string? DistanceFunction)
    {
        this.Dimensions = Dimensions;
    ...
    public VectorStoreVectorPropertyAttribute(int Dimensions, string? DistanceFunction, string? IndexKind)
    {
        this.Dimensions = Dimensions;
        this.DistanceFunction = DistanceFunction;
