...
public class KeywordHybridSearchMetadata
{
    ...
    /// <summary>
    /// Initializes an instance of <see cref="KeywordHybridSearchMetadata"/> from <see cref="VectorStoreRecordCollectionMetadata"/>.
    /// </summary>
    /// <param name="collectionMetadata">Instance of <see cref="VectorStoreRecordCollectionMetadata"/>.</param>
    public static KeywordHybridSearchMetadata From(VectorStoreRecordCollectionMetadata collectionMetadata)
    {
        return new()
        {
