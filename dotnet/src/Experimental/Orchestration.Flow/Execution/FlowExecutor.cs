...
internal class FlowExecutor : IFlowExecutor
{
    ...
    /// </summary>
    private readonly SKFunction _checkRepeatStepFunction;

    /// <summary>
    /// Check start step function
    /// </summary>
    private readonly SKFunction _checkStartStepFunction;
    ...
    private async Task<RepeatOrStartStepResult?> CheckRepeatOrStartStepAsync(ContextVariables context, SKFunction function, string sessionId, string checkRepeatOrStartStepId, string input)
    {
    ...
    private static SKFunction CreateSemanticFunction(Kernel kernel, string functionName, string promptTemplate, PromptTemplateConfig config)
    {
