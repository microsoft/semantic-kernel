...
internal sealed class ReActEngine
{
    ...
    /// </summary>
    private readonly SKFunction _reActFunction;
    ...
    private SKFunction ImportSemanticFunction(Kernel kernel, string functionName, string promptTemplate, PromptTemplateConfig config)
    {
