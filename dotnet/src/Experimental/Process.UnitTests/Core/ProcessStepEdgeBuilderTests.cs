...
public class ProcessStepEdgeBuilderTests
{
    ...
    /// <summary>
    /// Verify that the <see cref="ProcessStepEdgeBuilder.SendEventTo_Internal(ProcessFunctionTargetBuilder, System.Collections.Generic.Dictionary{string, object?}?)"/> method sets the output target.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Verify that the <see cref="ProcessStepEdgeBuilder.SendEventTo_Internal(ProcessFunctionTargetBuilder, System.Collections.Generic.Dictionary{string, object?}?)"/> method sets chained output targets.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Verify that the <see cref="ProcessStepEdgeBuilder.SendEventTo_Internal(ProcessFunctionTargetBuilder, System.Collections.Generic.Dictionary{string, object?}?)"/> method throws if the output target is already set.
    /// </summary>
    [Fact]
