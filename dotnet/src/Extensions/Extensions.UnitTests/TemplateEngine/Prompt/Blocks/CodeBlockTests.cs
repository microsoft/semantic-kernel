...
public class CodeBlockTests
{
    ...
    {
        // Arrange
        var context = new SKContext(this._functionExecutor.Object, functions: this._functions.Object);
    ...
    public async Task ItRendersCodeBlockConsistingOfJustAVarBlock1Async()
    {
        ...
        var context = new SKContext(this._functionExecutor.Object, variables, functions: this._functions.Object);
    ...
    public async Task ItInvokesFunctionWithCustomValueAsync()
    {
        ...
        var context = new SKContext(this._functionExecutor.Object, variables: null, functions: this._functions.Object);
        var funcId = new FunctionIdBlock(Func);
        var valBlock = new ValBlock($"'{Value}'");
    ...
    public async Task ItInvokesFunctionWithNamedArgsAsync()
    {
        ...
        var context = new SKContext(this._functionExecutor.Object, variables: variables, functions: this._functions.Object);
        var funcId = new FunctionIdBlock(Func);
