...
{
    /// <summary>
    /// Creates an <see cref="SKFunction"/> instance for a semantic function using the specified markdown resource.
    /// </summary>
    ...
    public static SKFunction FromPromptMarkdownResource(
        string resourceName,
        string functionName,
    ...
    /// <param name="loggerFactory">The <see cref="ILoggerFactory"/> to use for logging. If null, no logging will be performed.</param>
    /// <returns>The created <see cref="SKFunction"/>.</returns>
    public static SKFunction FromPromptMarkdown(
        string text,
        string functionName,
        string? pluginName = null,
        IPromptTemplateFactory? promptTemplateFactory = null,
