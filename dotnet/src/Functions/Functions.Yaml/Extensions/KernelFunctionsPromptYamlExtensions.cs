...
{
    /// <summary>
    /// Creates an <see cref="SKFunction"/> instance for a semantic function using the specified YAML resource.
    /// </summary>
    ...
    public static SKFunction CreateFunctionFromPromptYamlResource(
        this Kernel kernel,
        string resourceName,
    ...
    /// <summary>
    /// Creates an <see cref="SKFunction"/> instance for a semantic function using the specified YAML.
    /// </summary>
    /// <param name="kernel">Kernel instance</param>
    ...
    /// <param name="promptTemplateFactory">>Prompt template factory.</param>
    /// <returns>The created <see cref="SKFunction"/>.</returns>
    public static SKFunction CreateFunctionFromPromptYaml(
        this Kernel kernel,
        string text,
