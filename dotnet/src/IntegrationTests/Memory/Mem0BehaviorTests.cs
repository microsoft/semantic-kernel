...
public class Mem0BehaviorTests : IDisposable
{
    ...
    public async Task CanAddAndRetrieveMemoriesAsync()
    {
        ...
        Assert.DoesNotContain("Caoimhe", answerBeforeAdding.AdditionalInstructions);
        ...
        // Assert
        Assert.Contains("Caoimhe", answerAfterAdding.AdditionalInstructions);
        Assert.DoesNotContain("Caoimhe", answerAfterClearing.AdditionalInstructions);
    }
    ...
    public async Task DoesNotLeakMessagesAcrossScopesAsync()
    {
        ...
        Assert.DoesNotContain("Caoimhe", answerBeforeAdding1.AdditionalInstructions);
        Assert.DoesNotContain("Caoimhe", answerBeforeAdding2.AdditionalInstructions);
        ...
        // Assert
        Assert.Contains("Caoimhe", answerAfterAdding.AdditionalInstructions);
        Assert.DoesNotContain("Caoimhe", answerAfterAddingOnOtherScope.AdditionalInstructions);
