        ...
        foreach (var property in model.Properties)
        {
            switch (property)
            {
                ...
                case VectorStoreRecordDataPropertyModel dataProperty:
                    ...
                    {
                        dataProperties.Add(dataProperty.ModelName, GetDataPropertyValue(property.ModelName, property.ClrType, dataValue));
                    }
                    continue;
                ...
                case VectorStoreRecordVectorPropertyModel vectorProperty:
                    ...
                    {
                        vectorProperties.Add(vectorProperty.ModelName, GetVectorPropertyValue(property.ModelName, property.ClrType, vectorValue));
                    }
                    continue;
