...
internal static class SequentialPlanParser
{
    ...
    internal static Plan ToPlanFromXml(this string xmlString, string goal, Func<string, string, SKFunction?> getFunctionCallback, bool allowMissingFunctions = false)
    {
