...
public sealed class HandlebarsPlannerOptions : PlannerOptions
{
    ...
    /// <summary>
    /// Callback that returns an override for the CreatePlan prompt.
    /// </summary>
    /// <remarks>
    /// The callback should return a valid Handlebars template string. If this is set, the planner will use this prompt instead of the default prompt.
    ...
    /// </remarks>
    public Func<string>? GetCreatePlanPrompt { get; set; }
