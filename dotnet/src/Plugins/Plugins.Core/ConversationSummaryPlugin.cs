...
public class ConversationSummaryPlugin
{
    ...
    {
        this._summarizeConversationFunction = SKFunctionHelper.FromPrompt(
        ...
        this._conversationActionItemsFunction = SKFunctionHelper.FromPrompt(
        ...
        this._conversationTopicsFunction = SKFunctionHelper.FromPrompt(
