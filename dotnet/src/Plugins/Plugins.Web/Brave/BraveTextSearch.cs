...
public sealed class BraveTextSearch : ITextSearch
{
    ...
    /// <inheritdoc/>
    public async Task<KernelSearchResults<string>> SearchAsync(string query, TextSearchOptions? searchOptions = null,
    ...
    /// <inheritdoc/>
    public async Task<KernelSearchResults<TextSearchResult>> GetTextSearchResultsAsync(string query, TextSearchOptions? searchOptions = null,
        CancellationToken cancellationToken = new CancellationToken())
    {
         // searchOptions ??= new TextSearchOptions();
         //        BraveSearchResponse<BraveWebPage>? searchResponse = await this.ExecuteSearchAsync(query, searchOptions, cancellationToken).ConfigureAwait(false);
         //
    ...
    private async Task<BraveSearchResponse<BraveWebPage>?> ExecuteSearchAsync(string query, TextSearchOptions searchOptions, CancellationToken cancellationToken = default)
    {
        ...
        return JsonSerializer.Deserialize<BraveSearchResponse<BraveWebPage>>(json);
    }
