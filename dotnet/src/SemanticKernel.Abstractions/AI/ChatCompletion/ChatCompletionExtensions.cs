...
public static class ChatCompletionExtensions
{
    ...
    /// <summary>
    /// Get streaming completion StreamingResultChunk results for the prompt and settings.
    /// </summary>
    ...
    public static IAsyncEnumerable<StreamingContent> GetStreamingChunksAsync(
        this IChatCompletion chatCompletion,
        string input,
        AIRequestSettings? requestSettings = null,
        CancellationToken cancellationToken = default)
