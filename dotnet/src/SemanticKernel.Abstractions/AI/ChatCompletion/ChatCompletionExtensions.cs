...
public static class ChatCompletionExtensions
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        IReadOnlyList<IChatResult> chatResults = await chatCompletionService.GetChatCompletionsAsync(chat, executionSettings, kernel, cancellationToken).ConfigureAwait(false);
