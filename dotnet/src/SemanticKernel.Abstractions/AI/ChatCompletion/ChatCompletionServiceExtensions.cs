            ...
            switch (item)
            {
                ...
                case Microsoft.SemanticKernel.ImageContent ic:
                    aiContent =
                        ...
                        ic.Uri is not null ? new Microsoft.Extensions.AI.UriContent(ic.Uri, ic.MimeType) :
                        null;
                    break;
                ...
                case Microsoft.SemanticKernel.AudioContent ac:
                    aiContent =
                        ...
                        ac.Uri is not null ? new Microsoft.Extensions.AI.UriContent(ac.Uri, ac.MimeType) :
                        null;
                    break;
                ...
                case Microsoft.SemanticKernel.BinaryContent bc:
                    aiContent =
                        ...
                        bc.Uri is not null ? new Microsoft.Extensions.AI.UriContent(bc.Uri, bc.MimeType) :
                        null;
                    break;
