...
/// <summary>
/// Provides a collection of static methods for operating on <see cref="IGenericEmbeddingGenerationService{TValue,TEmbedding}"/> objects.
/// </summary>
...
public static class EmbeddingGenerationExtensions
{
    ...
    public static async Task<ReadOnlyMemory<TEmbedding>> GenerateEmbeddingAsync<TValue, TEmbedding>(
        this IGenericEmbeddingGenerationService<TValue, TEmbedding> generator,
        TValue value,
        Kernel? kernel = null,
