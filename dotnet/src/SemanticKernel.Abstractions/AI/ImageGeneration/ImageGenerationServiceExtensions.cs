...
public static class ImageGenerationServiceExtensions
{
    ...
    public static void AddImageGenerationService(
        ...
        bool setAsDefault = false) => services.SetService<IImageGenerationService>(serviceId, instance);
    ...
    public static void AddImageGenerationService(
        ...
        bool setAsDefault = false) => services.SetServiceFactory<IImageGenerationService>(serviceId, factory, setAsDefault);
    ...
    public static bool TryRemoveImageGenerationService(
        this INamedServiceCollection services, string serviceId) => services.TryRemove<IImageGenerationService>(serviceId);

    /// <summary>
    /// Remove all image generation services.
    /// </summary>
    public static void RemoveAllImageGenerationServices(
        this INamedServiceCollection services) => services.Clear<IImageGenerationService>();
    ...
    public static IEnumerable<string> GetImageGenerationServiceIds(
        this INamedServiceProvider services) => services.GetServiceNames<IImageGenerationService>();
    ...
    public static string? GetDefaultImageGenerationServiceId(
        this INamedServiceProvider services) => services.GetDefaultServiceName<IImageGenerationService>();
}
