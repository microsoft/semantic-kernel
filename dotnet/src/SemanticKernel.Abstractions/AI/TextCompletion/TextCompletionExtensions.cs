...
public static class TextCompletionExtensions
{
    ...
    {
        var completions = await textCompletion.GetCompletionsAsync(text, executionSettings, cancellationToken).ConfigureAwait(false);
    ...
    public static IAsyncEnumerable<StreamingContent> GetStreamingContentAsync(
        ...
        PromptExecutionSettings? executionSettings = null,
        CancellationToken cancellationToken = default)
        => textCompletion.GetStreamingContentAsync<StreamingContent>(input, executionSettings, cancellationToken);
}
