...
public static class TextCompletionExtensions
{
    ...
    public static async IAsyncEnumerable<string> CompleteStreamAsync2(this ITextCompletion textCompletion,
        string text,
        AIRequestSettings? requestSettings = null,
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> to monitor for cancellation requests. The default is <see cref="CancellationToken.None"/>.</param>
    /// <returns>Streaming content of the text generated by the remote model.</returns>
    public static async IAsyncEnumerable<string> CompleteStreamsAsync2(this ITextCompletion textCompletion,
        string text,
        AIRequestSettings? requestSettings = null,
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
