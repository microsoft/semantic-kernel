...
public static class TextGenerationExtensions
{
    ...
    public static async Task<string> CompleteAsync(this ITextGeneration textCompletion,
        string text,
        PromptExecutionSettings? executionSettings = null,
        Kernel? kernel = null,
        CancellationToken cancellationToken = default)
    {
        var completions = await textCompletion.GetCompletionsAsync(text, executionSettings, kernel, cancellationToken).ConfigureAwait(false);
    ...
    public static IAsyncEnumerable<StreamingContent> GetStreamingContentAsync(
        this ITextGeneration textCompletion,
        string input,
        PromptExecutionSettings? executionSettings = null,
        Kernel? kernel = null,
        CancellationToken cancellationToken = default)
        => textCompletion.GetStreamingContentAsync<StreamingContent>(input, executionSettings, kernel, cancellationToken);
}
