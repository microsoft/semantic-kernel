...
{
    /// <summary>
    /// Get a first text generation result for the prompt and settings.
    /// </summary>
    ...
    /// <returns>First text generation result for the prompt and settings.</returns>
    public static async Task<TextContent> GetTextContentAsync(
        ...
        => (await textGenerationService.GetTextContentsAsync(prompt, executionSettings, kernel, cancellationToken).ConfigureAwait(false))[0];
