...
public sealed class PromptFilterCollection : IList<IPromptFilter>, IReadOnlyList<IPromptFilter>
{
    ...
    /// </summary>
    private readonly List<IPromptFilter> _filters;

    /// <summary>
    /// Initializes a new instance of the <see cref="PromptFilterCollection"/> class.
    /// </summary>
    public PromptFilterCollection() => this._filters = new();

    /// <summary>
    /// Initializes a new instance of the <see cref="PromptFilterCollection"/> class.
    /// </summary>
    /// <param name="filters">The initial collection of filters to populate this collection.</param>
    public PromptFilterCollection(IEnumerable<IPromptFilter> filters)
    {
    ...
    public IPromptFilter this[int index]
    {
    ...
    public void Add(IPromptFilter item)
    {
        Verify.NotNull(item);
    ...
    /// <exception cref="ArgumentNullException"><paramref name="item"/> is null.</exception>
    public bool Contains(IPromptFilter item)
    {
        Verify.NotNull(item);
    ...
    public void CopyTo(IPromptFilter[] array, int arrayIndex) => this._filters.CopyTo(array, arrayIndex);
    ...
    public int IndexOf(IPromptFilter item)
    {
        Verify.NotNull(item);
    ...
    /// <exception cref="ArgumentNullException"><paramref name="item"/> is null.</exception>
    public void Insert(int index, IPromptFilter item)
    {
        Verify.NotNull(item);
    ...
    /// <exception cref="ArgumentNullException"><paramref name="item"/> is null.</exception>
    public bool Remove(IPromptFilter item)
    {
        Verify.NotNull(item);
    ...
    bool ICollection<IPromptFilter>.IsReadOnly => false;

    IEnumerator IEnumerable.GetEnumerator() => this._filters.GetEnumerator();

    IEnumerator<IPromptFilter> IEnumerable<IPromptFilter>.GetEnumerator() => this._filters.GetEnumerator();
}
