...
/// </remarks>
public interface ISKPlugin : IEnumerable<SKFunction>
{
    ...
    SKFunction this[string functionName] { get; }
    ...
    bool TryGetFunction(string name, [NotNullWhen(true)] out SKFunction? function);
}
