...
public interface INamedServiceProvider
{
    ...
    /// <summary>
    /// Gets the service of the specified type and name, or throws an exception if not found.
    /// </summary>
    /// <typeparam name="T">The type of the service.</typeparam>
    /// <param name="name">The name of the service, or null for the default service.</param>
    /// <returns>The service instance.</returns>
    /// <exception cref="InvalidOperationException">The service was not found.</exception>
