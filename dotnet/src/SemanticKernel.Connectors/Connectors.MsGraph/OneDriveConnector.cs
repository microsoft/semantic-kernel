...
using Microsoft.SemanticKernel.Connectors.MsGraph.Diagnostics;
using Microsoft.SemanticKernel.Connectors.MsGraph.Exceptions;

namespace Microsoft.SemanticKernel.Connectors.MsGraph;

/// <summary>
/// Connector for OneDrive API
/// </summary>
public class OneDriveConnector : ICloudDriveConnector, IFileSystemConnector
{
