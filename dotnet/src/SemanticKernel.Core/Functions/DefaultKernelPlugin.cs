...
public sealed class DefaultKernelPlugin : KernelPlugin
{
    ...
    public DefaultKernelPlugin(string name) : this(name, description: null, functions: null)
    {
    }
    ...
    public DefaultKernelPlugin(string name, IEnumerable<KernelFunction>? functions) : this(name, description: null, functions)
    {
    }
