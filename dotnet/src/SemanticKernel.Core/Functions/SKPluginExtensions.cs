...
public static class SKPluginExtensions
{
        ...
        ILoggerFactory? loggerFactory = null)
    {
        ...
        ISKFunction function = KernelFunctionFromMethod.Create(method.Method, method.Target, functionName, description, parameters, returnParameter, loggerFactory);
        ...
        ILoggerFactory? loggerFactory = null)
    {
        ...
        ISKFunction function = KernelFunctionFromMethod.Create(method, target, functionName, description, parameters, returnParameter, loggerFactory);
        plugin.AddFunction(function);
        return function;
    }
    #endregion
        ...
        ILoggerFactory? loggerFactory = null)
    {
        ...
        ISKFunction function = KernelFunctionFromPrompt.Create(promptTemplate, requestSettings, functionName, description, loggerFactory);
        plugin.AddFunction(function);
        return function;
    }
        ...
        ILoggerFactory? loggerFactory = null)
    {
        ...
        ISKFunction function = KernelFunctionFromPrompt.Create(promptTemplate, promptTemplateConfig, functionName, promptTemplateFactory, loggerFactory);
        plugin.AddFunction(function);
        return function;
    }
        ...
        ILoggerFactory? loggerFactory = null)
    {
        ...
        ISKFunction function = KernelFunctionFromPrompt.Create(promptTemplate, promptTemplateConfig, functionName, loggerFactory);
        plugin.AddFunction(function);
        return function;
    }
    #endregion
