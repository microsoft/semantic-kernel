...
public static class KernelExtensions
{
    ...
    /// <summary>
    /// Creates an <see cref="SKFunction"/> instance for a method, specified via a delegate.
    /// </summary>
    ...
    public static SKFunction CreateFunctionFromMethod(
        this Kernel kernel,
        Delegate method,
        ...
        ReturnParameterView? returnParameter = null)
    {
        ...
        return SKFunctionHelper.FromMethod(method.Method, method.Target, functionName, description, parameters, returnParameter, kernel.LoggerFactory);
    }
        ...
        ReturnParameterView? returnParameter = null)
    {
        ...
        return SKFunctionHelper.FromMethod(method, target, functionName, description, parameters, returnParameter, kernel.LoggerFactory);
    }
    #endregion
    ...
    public static SKFunction CreateFunctionFromPrompt(
        this Kernel kernel,
        ...
        string? description = null)
    {
        ...
        return SKFunctionHelper.FromPrompt(promptTemplate, requestSettings, functionName, description, kernel.LoggerFactory);
    }
        ...
        IPromptTemplateFactory? promptTemplateFactory = null)
    {
        ...
        return SKFunctionHelper.FromPrompt(promptTemplate, promptTemplateConfig, functionName, promptTemplateFactory, kernel.LoggerFactory);
    }
        ...
        string? functionName = null)
    {
        ...
        return SKFunctionHelper.FromPrompt(promptTemplate, promptTemplateConfig, functionName, kernel.LoggerFactory);
    }
    #endregion
    ...
    public static Task<KernelResult> InvokePromptAsync(
        ...
        string? functionName = null,
        string? description = null) =>
        kernel.RunAsync((SKFunction)SKFunctionHelper.FromPrompt(
            promptTemplate,
            requestSettings,
            functionName,
            description));
    ...
    /// <summary>
    /// Run a single synchronous or asynchronous <see cref="SKFunction"/>.
    /// </summary>
    /// <param name="kernel">The kernel.</param>
    ...
    /// <returns>Result of the function composition</returns>
    /// <inheritdoc/>
    public static async Task<KernelResult> RunAsync(this Kernel kernel, ContextVariables variables, CancellationToken cancellationToken, params SKFunction[] pipeline)
    {
        ...
        foreach (SKFunction skFunction in pipeline)
        {
repeat:
    ...
    /// <returns></returns>
    private static bool IsCancelRequested(SKFunction skFunction, SKContext context, int pipelineStepCount, ILogger logger)
    {
    ...
    /// <param name="logger">The logger.</param>
    /// <returns></returns>
    private static bool IsSkipRequested(SKFunction skFunction, SKContext context, int pipelineStepCount, ILogger logger)
    {
    ...
    /// <param name="logger">The logger.</param>
    /// <returns></returns>
    private static bool IsRepeatRequested(SKFunction skFunction, SKContext context, int pipelineStepCount, ILogger logger)
    {
