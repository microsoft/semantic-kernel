...
/// <summary>
/// Extension methods for <see cref="AIContextAdditions"/>.
/// </summary>
...
public static class AIContextAdditionsExtensions
{
    ...
    /// </summary>
    /// <param name="aiContextAdditions">The <see cref="AIContextAdditions"/> to get plugins from.</param>
    /// <param name="kernel">The kernel to register the plugins on.</param>
    public static void RegisterPlugins(this AIContextAdditions aiContextAdditions, Kernel kernel)
    {
