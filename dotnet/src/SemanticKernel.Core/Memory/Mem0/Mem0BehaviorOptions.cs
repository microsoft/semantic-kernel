...
/// <summary>
/// Options for the <see cref="Mem0Behavior"/>.
/// </summary>
[Experimental("SKEXP0130")]
public sealed class Mem0BehaviorOptions
{
    /// <summary>
    ...
    /// </summary>
    /// <remarks>
    /// This value will be overridden by any thread id provided to the methods of the <see cref="Mem0Behavior"/>.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// This setting is useful if the thread id is not known when the <see cref="Mem0Behavior"/> is instantiated, but
