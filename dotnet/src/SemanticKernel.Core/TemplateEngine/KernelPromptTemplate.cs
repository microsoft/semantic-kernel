...
<<<<<<<< HEAD:dotnet/src/SemanticKernel.Core/PromptTemplate/KernelPromptTemplate.cs
...
>>>>>>>> b5e22903 (Python: Make SK compatible with OpenAI 1.0 (#3470)):dotnet/src/SemanticKernel.Core/TemplateEngine/KernelPromptTemplate.cs
