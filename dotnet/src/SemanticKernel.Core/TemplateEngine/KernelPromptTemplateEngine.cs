...
/// </summary>
[Obsolete("Use KernelPromptTemplateFactory instead. This will be removed in a future release.")]
[EditorBrowsable(EditorBrowsableState.Never)]
public class KernelPromptTemplateEngine : IPromptTemplateEngine
{
    ...
    public KernelPromptTemplateEngine(ILoggerFactory? loggerFactory = null)
    {
        this._loggerFactory = loggerFactory ?? NullLoggerFactory.Instance;
        this._logger = this._loggerFactory.CreateLogger(typeof(KernelPromptTemplateEngine));
