...
public interface IVectorDbCollection
{
    ...
    Task<IAsyncEnumerable<DataEntry<VectorRecordData<float>>>> GetAllVectorsAsync();
...
{
    public static Task UpsertVectorAsync(this IVectorDbCollection collection, string id, float[] data, IEnumerable<string>? tags = null, Dictionary<string, object>? payload = null)
    {
    ...
    public static IAsyncEnumerable<KeyValuePair<DataEntry<VectorRecordData<float>>, double>> FindClosestAsync(this IVectorDbCollection collection, DataEntry<VectorRecordData<float>> record, int top = 1, string[]? requiredTags = null)
    {
