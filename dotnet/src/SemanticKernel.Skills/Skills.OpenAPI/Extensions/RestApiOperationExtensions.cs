...
internal static class RestApiOperationExtensions
{
    ...
    public static IReadOnlyList<RestApiOperationParameter> GetParameters(this RestApiOperation operation)
    {
        ...
        parameters.Add(new RestApiOperationParameter(RestApiOperation.ServerUrlArgumentName, "string", false, RestApiOperationParameterLocation.Path, RestApiOperationParameterStyle.Simple, null, operation.ServerUrl));
    ...
    private static IEnumerable<RestApiOperationParameter> CreateParametersFromPayloadProperties(RestApiOperationPayload? payload)
    {
        ...
        IList<RestApiOperationParameter> ConverLeafProperties(RestApiOperationPayloadProperty property)
        {
            ...
            {
                parameters.Add(new RestApiOperationParameter(property.Name, property.Type, property.IsRequired, RestApiOperationParameterLocation.Body, RestApiOperationParameterStyle.Simple, null, null, property.Description));
            }
