...
using Microsoft.SemanticKernel.Adapters.WebApi.Rest;
using Microsoft.SemanticKernel.Adapters.WebApi.Rest.Model;
using Moq;
using Xunit;

namespace SemanticKernel.UnitTests.Adapters.WebApi.Rest;
