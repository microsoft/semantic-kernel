...
/// </summary>
public sealed class ImageContentOldTests
{
    [Fact]
    public void ToStringForUriReturnsString()
    {
        // Arrange
        var content1 = new ImageContentOld((Uri)null!);
        var content2 = new ImageContentOld(new Uri("https://endpoint/"));
    ...
    public void ToStringForDataUriReturnsDataUriString()
    {
        ...
        var content1 = new ImageContentOld(data) { MimeType = "text/plain" };
    ...
    public void ToStringForUriAndDataUriReturnsDataUriString()
    {
        // Arrange
        var data = BinaryData.FromString("this is a test");
        var content1 = new ImageContentOld(data)
        {
            MimeType = "text/plain",
    ...
    public void CreateForEmptyDataUriThrows()
    {
        ...
        Assert.Throws<ArgumentException>(()
            => new ImageContentOld(data) { MimeType = "text/plain" });
    }
    ...
    public void ToStringForDataUriFromStreamReturnsDataUriString()
    {
        ...
        Assert.Throws<ArgumentException>(() => new ImageContentOld(BinaryData.FromStream(ms)) { MimeType = null! });
    }
    ...
    {
        // Arrange
        var sut = new ImageContentOld(new byte[] { 1, 2, 3 }) { MimeType = null };
    ...
    // Additional Tests for Non Tested Scenarios
    ...
    public void ToStringShouldReturn(string? mimeType, string? path, string expectedToString)
    {
        ...
        var data = BinaryData.FromBytes(bytes);
        var content1 = new ImageContentOld(data) { MimeType = mimeType };
        if (path is not null)
        {
    ...
    public void UpdatingUriPropertyShouldReturnAsExpected()
    {
        // Arrange
        var data = BinaryData.FromString("this is a test");
        var content = new ImageContentOld(data) { MimeType = "text/plain" };
    ...
    {
        var content = new ImageContentOld();
        var serialized = JsonSerializer.Serialize(content);
        var deserialized = JsonSerializer.Deserialize<ImageContentOld>(serialized);
...
#pragma warning disable CS8604 // Possible null reference argument.
        ...
        var content = new ImageContentOld(uri);
        var serialized = JsonSerializer.Serialize(content);
        var deserialized = JsonSerializer.Deserialize<ImageContentOld>(serialized);
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
    ...
    public void DataConstructorSerializationAndDeserializationAsExpected(string base64data)
    {
        ...
        var content = new ImageContentOld(data)
        {
            Uri = expectedUri
        };
