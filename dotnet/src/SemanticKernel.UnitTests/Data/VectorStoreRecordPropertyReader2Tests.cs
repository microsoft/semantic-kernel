...
public class VectorStoreRecordPropertyReader2Tests
{
    [Theory]
    ...
    {
        // Act & Assert.
        var exception = Assert.Throws<ArgumentException>(() => new VectorStoreRecordPropertyReader2(type, definition, null));
    ...
    {
        // Act & Assert.
        var sut = new VectorStoreRecordPropertyReader2(type, definition, new VectorStoreRecordPropertyReader2Options { SupportsMultipleKeys = true });
    }
    ...
    {
        // Act & Assert.
        var exception = Assert.Throws<ArgumentException>(() => new VectorStoreRecordPropertyReader2(type, definition, new VectorStoreRecordPropertyReader2Options { SupportsMultipleKeys = false }));
    ...
    {
        // Act & Assert.
        var sut = new VectorStoreRecordPropertyReader2(type, definition, new VectorStoreRecordPropertyReader2Options { SupportsMultipleVectors = true });
    }
    ...
    {
        // Act & Assert.
        var exception = Assert.Throws<ArgumentException>(() => new VectorStoreRecordPropertyReader2(type, definition, new VectorStoreRecordPropertyReader2Options { SupportsMultipleVectors = false }));
    ...
    {
        // Arrange.
        var sut = new VectorStoreRecordPropertyReader2(type, definition, null);
    ...
    {
        // Arrange.
        var sut = new VectorStoreRecordPropertyReader2(type, definition, new()
        {
