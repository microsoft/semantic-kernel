...
public class FunctionViewTests
{
    ...
    {
        // Act
        var function = SKFunctionHelper.FromMethod(Method(ValidFunctionName), loggerFactory: this._logger.Object);
    ...
    {
        // Act
        var function = SKFunctionHelper.FromMethod(Method(ValidFunctionNameAsync), loggerFactory: this._logger.Object);
        Assert.NotNull(function);
        FunctionView fv = function.Describe();
    ...
    public void ItSupportsValidFunctionSKNameAttributeOverride()
    {
        ...
        // Act
        var function = SKFunctionHelper.FromMethod(Method(TestFunctionName), loggerFactory: this._logger.Object);
        Assert.NotNull(function);
    ...
    {
        var function = SKFunctionHelper.FromMethod(Method(ValidFunctionName));
