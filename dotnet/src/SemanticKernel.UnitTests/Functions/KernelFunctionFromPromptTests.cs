...
public class KernelFunctionFromPromptTests
{
    ...
    public void ItProvidesAccessToFunctionsViaFunctionCollection()
    {
        ...
        kernel.Plugins.Add(new DefaultKernelPlugin("jk", functions: new[] { kernel.CreateFunctionFromPrompt(promptTemplate: "Tell me a joke", functionName: "joker", description: "Nice fun") }));
