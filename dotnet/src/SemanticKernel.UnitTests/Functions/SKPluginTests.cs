...
public class SKPluginTests
{
    ...
    public void ItRoundTripsCtorArguments()
    {
        ...
        var functions = new[]
        {
            SKFunctionHelper.FromMethod(() => { }, "Function1"),
            SKFunctionHelper.FromMethod(() => { }, "Function2"),
            SKFunctionHelper.FromMethod(() => { }, "Function3"),
        };
    ...
    public void ItContainsAddedFunctions()
    {
        ...
        Assert.Throws<ArgumentException>(() => plugin.AddFunction(SKFunctionHelper.FromMethod(() => { }, "function1")));
        Assert.Throws<ArgumentException>(() => plugin.AddFunction(SKFunctionHelper.FromMethod(() => { }, "FUNCTION2")));
    }
