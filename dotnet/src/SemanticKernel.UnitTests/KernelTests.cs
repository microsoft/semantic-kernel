...
public class KernelTests
{
    ...
    public void ItProvidesAccessToFunctionsViaFunctionCollection()
    {
        ...
        kernel.ImportFunctions(plugin, "mySk");
    ...
    public async Task RunAsyncDoesNotRunWhenCancelledAsync()
    {
        ...
        var plugin = new MyPlugin();
        var functions = kernel.ImportFunctions(plugin, "mySk");
    ...
    public async Task ItReturnsFunctionResultsCorrectlyAsync()
    {
        ...
        var function1 = SKFunction.FromMethod(Method(Function1), pluginName: PluginName);
        var function2 = SKFunction.FromMethod(Method(Function2), pluginName: PluginName);
    ...
    public async Task ItReturnsChangedResultsFromFunctionInvokedEventsAsync()
    {
        ...
        [SKName("Function1")]
        static string Function1() => "Result1";
        var function1 = SKFunction.FromMethod(Method(Function1), pluginName: "MyPlugin");
    ...
    public async Task ItRepeatsFunctionInvokedEventsAsync(string retryFunction, int numberOfRepeats)
    {
        ...
        var function2 = SKFunction.FromMethod(Method(Function2), pluginName: "MyPlugin");
    ...
    public async Task ItSkipsFunctionsFromFunctionInvokingEventsAsync(string skipFunction, string expectedResult)
    {
        ...
        var function1 = SKFunction.FromMethod(Method(Function1), pluginName: PluginName);
        var function2 = SKFunction.FromMethod(Method(Function2), pluginName: PluginName);
        var function3 = SKFunction.FromMethod(Method(Function3), pluginName: PluginName);
    ...
    public async Task ItCancelsPipelineFromFunctionInvokingEventsAsync(int numberOfFunctions, int functionCancelIndex, int expectedInvocations)
    {
        ...
        [SKName("Function1")]
        static string Function1() => "Result1";
        functions.Add(SKFunction.FromMethod(Method(Function1), pluginName: PluginName));

        [SKName("Function2")]
        static string Function2() => "Result2";
        functions.Add(SKFunction.FromMethod(Method(Function2), pluginName: PluginName));

        [SKName("Function3")]
        static string Function3() => "Result3";
        functions.Add(SKFunction.FromMethod(Method(Function3), pluginName: PluginName));

        [SKName("Function4")]
        static string Function4() => "Result4";
        functions.Add(SKFunction.FromMethod(Method(Function4), pluginName: PluginName));

        [SKName("Function5")]
        static string Function5() => "Result5";
        functions.Add(SKFunction.FromMethod(Method(Function5), pluginName: PluginName));
