...
public sealed class PlanTests
{
    ...
    public async Task CanExecutePlanWithPlanStepAsync()
    {
        ...
        mockFunction.Setup(x => x.InvokeAsync(It.IsAny<SKContext>(), null, null, It.IsAny<CancellationToken>()))
            .Callback<SKContext, CompleteRequestSettings?, ITextCompletion?, CancellationToken>((c, s, tc, ct) =>
        ...
        mockFunction.Verify(x => x.InvokeAsync(It.IsAny<SKContext>(), null, null, It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task CanExecutePlanWithFunctionStepsAsync()
    {
        ...
        mockFunction.Verify(x => x.InvokeAsync(It.IsAny<SKContext>(), null, null, It.IsAny<CancellationToken>()), Times.Exactly(2));
    }
    ...
    public async Task CanExecutePanWithTreeStepsAsync()
    {
        ...
        childFunction1.Setup(x => x.InvokeAsync(It.IsAny<SKContext>(), null, null, It.IsAny<CancellationToken>()))
            .Callback<SKContext, CompleteRequestSettings?, ITextCompletion?, CancellationToken>((c, s, tc, ct) =>
                returnContext.Variables.Update("Child 1 output!" + c.Variables.Input))
            .Returns(() => Task.FromResult(returnContext));
        var childFunction2 = new Mock<ISKFunction>();
        childFunction2.Setup(x => x.InvokeAsync(It.IsAny<SKContext>(), null, null, It.IsAny<CancellationToken>()))
            .Callback<SKContext, CompleteRequestSettings?, ITextCompletion?, CancellationToken>((c, s, tc, ct) =>
                returnContext.Variables.Update("Child 2 is happy about " + c.Variables.Input))
            .Returns(() => Task.FromResult(returnContext));
        var childFunction3 = new Mock<ISKFunction>();
        childFunction3.Setup(x => x.InvokeAsync(It.IsAny<SKContext>(), null, null, It.IsAny<CancellationToken>()))
            .Callback<SKContext, CompleteRequestSettings?, ITextCompletion?, CancellationToken>((c, s, tc, ct) =>
                returnContext.Variables.Update("Child 3 heard " + c.Variables.Input))
            .Returns(() => Task.FromResult(returnContext));

        var nodeFunction1 = new Mock<ISKFunction>();
        nodeFunction1.Setup(x => x.InvokeAsync(It.IsAny<SKContext>(), null, null, It.IsAny<CancellationToken>()))
            .Callback<SKContext, CompleteRequestSettings?, ITextCompletion?, CancellationToken>((c, s, tc, ct) =>
        ...
        nodeFunction1.Verify(x => x.InvokeAsync(It.IsAny<SKContext>(), null, null, It.IsAny<CancellationToken>()), Times.Once);
        childFunction1.Verify(x => x.InvokeAsync(It.IsAny<SKContext>(), null, null, It.IsAny<CancellationToken>()), Times.Once);
        childFunction2.Verify(x => x.InvokeAsync(It.IsAny<SKContext>(), null, null, It.IsAny<CancellationToken>()), Times.Once);
        childFunction3.Verify(x => x.InvokeAsync(It.IsAny<SKContext>(), null, null, It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task CanExecutePlanWithCustomStateAsync()
    {
        ...
        mockFunction.Verify(x => x.InvokeAsync(It.IsAny<SKContext>(), null, null, It.IsAny<CancellationToken>()), Times.Exactly(3));
    }
    ...
    public async Task CanExecutePlanWithJoinedResultAsync()
    {
        ...
        outlineMock.Setup(x => x.InvokeAsync(It.IsAny<SKContext>(), null, null, It.IsAny<CancellationToken>()))
            .Callback<SKContext, CompleteRequestSettings?, ITextCompletion?, CancellationToken>((c, s, tc, ct) =>
        ...
        elementAtIndexMock.Setup(x => x.InvokeAsync(It.IsAny<SKContext>(), null, null, It.IsAny<CancellationToken>()))
            .Callback<SKContext, CompleteRequestSettings?, ITextCompletion?, CancellationToken>((c, s, tc, ct) =>
            {
        ...
        novelChapterMock.Setup(x => x.InvokeAsync(It.IsAny<SKContext>(), null, null, It.IsAny<CancellationToken>()))
            .Callback<SKContext, CompleteRequestSettings?, ITextCompletion?, CancellationToken>((c, s, tc, ct) =>
            {
...
Previously:Outline section #1 of 3: Here is a 3 chapter outline about NovelOutline function input.";
    ...
    public async Task CanExecutePlanWithExpandedAsync()
    {
        ...
        functionMock.Setup(x => x.InvokeAsync(It.IsAny<SKContext>(), null, null, It.IsAny<CancellationToken>()))
            .Callback<SKContext, CompleteRequestSettings?, ITextCompletion?, CancellationToken>((c, s, tc, ct) =>
