...
public class CodeBlockTests
{
    ...
    public async Task ItThrowsIfAFunctionCallThrowsAsync()
    {
        ...
        this._kernel.Plugins.Add(new DefaultKernelPlugin("plugin", new[] { function }));
    ...
    public async Task ItReturnsArgumentValueAndTypeAsync()
    {
        ...
        this._kernel.Plugins.Add(new DefaultKernelPlugin("p", new[] { KernelFunctionFactory.CreateFromMethod((object p1) =>
        {
            canary = p1;
        }, "f") }));
