...
public sealed class KernelPromptTemplateTests
{
    ...
    public async Task ItRendersCodeUsingInputAsync()
    {
        ...
        var func = SKFunctionHelper.FromMethod(Method(MyFunctionAsync), this, "function");
    ...
    public async Task ItHandlesSyntaxErrorsAsync()
    {
        ...
        SKFunction func = SKFunctionHelper.FromMethod(Method(MyFunctionAsync), this);
        Assert.NotNull(func);
    ...
    public async Task ItRendersCodeUsingImplicitInputAndNamedVariablesAsync()
    {
        ...
        SKFunction func = SKFunctionHelper.FromMethod(Method(MyFunctionAsync), this, "function");
    ...
    public async Task ItRendersAsyncCodeUsingImmutableVariablesAsync()
    {
        ...
        var functions = new List<SKFunction>()
        {
            SKFunctionHelper.FromMethod(Method(MyFunction1Async), this, "func1"),
            SKFunctionHelper.FromMethod(Method(MyFunction2Async), this, "func2"),
            SKFunctionHelper.FromMethod(Method(MyFunction3Async), this, "func3")
        };
    ...
    private SKContext MockContext(params SKFunction[] functions)
    {
