...
#pragma warning restore VSTHRD002 // Avoid problematic synchronous waits
    ...
    [InlineData("작은 마을에서 살던 쥐는 언젠가 큰 도시로 모험을 떠나기로 결심했습니다. 그는 작은 가방을 메고 기차에 탔습니다.\n\n도시는 그에게 놀라움의 연속이었습니다. 높은 빌딩, " +
