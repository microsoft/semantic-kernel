...
public static class MemoryConfiguration
{
    ...
    {
        var embeddingGenerator = kernel.GetService<ITextEmbeddingService>(embeddingsServiceId);
    ...
    public static void UseMemory(this IKernel kernel, ITextEmbeddingService embeddingGenerator, IMemoryStore storage)
    {
