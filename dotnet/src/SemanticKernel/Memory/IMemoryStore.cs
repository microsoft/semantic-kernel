...
public interface IMemoryStore
{
    ...
    /// <summary>
    /// Upserts a memory record into the datastore. Does not guaranteed that the collection exists.
    ...
    /// <summary>
    /// Upserts a group of memory records into the datastore. Does not guaranteed that the collection exists.
    ///     If the record already exists, it will be updated.
    ///     If the record does not exist, it will be created.
    /// </summary>
    /// <param name="collectionName">The name associated with a collection of vectors.</param>
    ...
    /// <summary>
    /// Gets a memory record from the datastore. Does not guaranteed that the collection exists.
    /// </summary>
    /// <param name="collectionName">The name associated with a collection of vectors.</param>
    ...
    /// <summary>
    /// Gets a batch of memory records from the datastore. Does not guaranteed that the collection exists.
    /// </summary>
    /// <param name="collectionName">The name associated with a collection of vectors.</param>
    ...
    /// <summary>
    /// Removes a memory record from the datastore. Does not guaranteed that the collection exists.
    /// </summary>
    /// <param name="collectionName">The name associated with a collection of vectors.</param>
    ...
    /// <summary>
    /// Removes a batch of memory records from the datastore. Does not guaranteed that the collection exists.
    /// </summary>
    /// <param name="collectionName">The name associated with a collection of vectors.</param>
    ...
    /// <summary>
    /// Gets the nearest matches to the <see cref="Embedding"/> of type <see cref="float"/>. Does not guaranteed that the collection exists.
    /// </summary>
    /// <param name="collectionName">The name associated with a collection of vectors.</param>
    ...
    /// <summary>
    /// Gets the nearest match to the <see cref="Embedding"/> of type <see cref="float"/>. Does not guaranteed that the collection exists.
    /// </summary>
    /// <param name="collectionName">The name associated with a collection of vectors.</param>
