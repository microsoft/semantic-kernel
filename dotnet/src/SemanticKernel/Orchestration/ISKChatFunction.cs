...
/// </summary>
public interface ISKChatFunction
{
    /// <summary>
    ...
    ISKChatFunction SetDefaultSkillCollection(IReadOnlySkillCollection skills);
    ...
    /// <returns>Self instance</returns>
    ISKChatFunction SetAIBackend(Func<IChatCompletionClient> backendFactory);
    ...
    /// <param name="settings">LLM completion settings</param>
    /// <returns>Self instance</returns>
    ISKChatFunction SetAIConfiguration(CompleteRequestSettings settings);
}
