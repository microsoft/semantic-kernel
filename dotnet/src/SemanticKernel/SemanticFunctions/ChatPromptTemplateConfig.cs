...
/// </summary>
public class ChatPromptTemplateConfig
{
    /// <summary>
    ...
    public ChatPromptTemplateConfig Compact()
    {
    ...
    public static ChatPromptTemplateConfig FromJson(string json)
    {
        var result = Json.Deserialize<ChatPromptTemplateConfig>(json);
