...
public sealed class SKFunction : ISKFunction, IDisposable
{
    ...
    private Func<ITextCompletion?, CompleteRequestSettings?, SKContext, PreExecutionHook?, PostExecutionHook?, CancellationToken, Task<SKContext>> _function;
    ...
    {
        public Func<ITextCompletion?, CompleteRequestSettings?, SKContext, PreExecutionHook?, PostExecutionHook?, CancellationToken, Task<SKContext>> Function { get; set; }
    ...
    internal SKFunction(
        Func<ITextCompletion?, CompleteRequestSettings?, SKContext, PreExecutionHook?, PostExecutionHook?, CancellationToken, Task<SKContext>> delegateFunction,
    ...
    private static (Func<ITextCompletion?, CompleteRequestSettings?, SKContext, PreExecutionHook?, PostExecutionHook?, CancellationToken, Task<SKContext>> function, List<ParameterView>) GetDelegateInfo(object? instance, MethodInfo method)
    {
        ...
        // Create the func
        Func<ITextCompletion?, CompleteRequestSettings?, SKContext, PreExecutionHook?, PostExecutionHook?, CancellationToken, Task<SKContext>> function = (_, _, context, _, _, cancellationToken) =>
        {
