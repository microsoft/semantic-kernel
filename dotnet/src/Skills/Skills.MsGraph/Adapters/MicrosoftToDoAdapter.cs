...
/// <summary>
/// Adapter for Microsoft To-Do API
/// </summary>
public class MicrosoftToDoAdapter : ITaskManagementAdapter
{
    private readonly GraphServiceClient _graphServiceClient;

    /// <summary>
    /// Initializes a new instance of the <see cref="MicrosoftToDoAdapter"/> class.
    /// </summary>
    /// <param name="graphServiceClient">A graph service client.</param>
    public MicrosoftToDoAdapter(GraphServiceClient graphServiceClient)
    {
    ...
    public async Task<TaskManagementTaskList?> GetDefaultTaskListAsync(CancellationToken cancellationToken = default)
    {
        ...
        if (result == null)
        {
            throw new MsGraphAdapterException("Could not find default task list.");
        }
