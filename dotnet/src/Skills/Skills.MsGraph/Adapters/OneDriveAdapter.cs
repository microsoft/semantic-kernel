...
using Microsoft.SemanticKernel.Skills.MsGraph.Adapters.Exceptions;

namespace Microsoft.SemanticKernel.Skills.MsGraph.Adapters;

/// <summary>
/// Adapter for OneDrive API
/// </summary>
public class OneDriveAdapter : ICloudDriveAdapter
{
    private readonly GraphServiceClient _graphServiceClient;

    /// <summary>
    /// Initializes a new instance of the <see cref="OneDriveAdapter"/> class.
    /// </summary>
    /// <param name="graphServiceClient">A graph service client.</param>
    public OneDriveAdapter(GraphServiceClient graphServiceClient)
    {
    ...
    /// <inheritdoc/>
    /// <exception cref="NotImplementedException">This method is not yet supported for <see cref="OneDriveAdapter"/>.</exception>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new MsGraphAdapterException("Shareable file link was null or whitespace.");
        }
