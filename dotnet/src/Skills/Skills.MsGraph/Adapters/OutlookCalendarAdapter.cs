...
/// <summary>
/// Adapter for Outlook Calendar API
/// </summary>
public class OutlookCalendarAdapter : ICalendarAdapter
{
    private readonly GraphServiceClient _graphServiceClient;

    /// <summary>
    /// Initializes a new instance of the <see cref="OutlookCalendarAdapter"/> class.
    /// </summary>
    /// <param name="graphServiceClient">A graph service client.</param>
    public OutlookCalendarAdapter(GraphServiceClient graphServiceClient)
    {
