...
/// Bing API adapter.
/// </summary>
public class BingAdapter : IWebSearchEngineAdapter, IDisposable
{
    private readonly ILogger _logger;
    private readonly HttpClientHandler _httpClientHandler;
    private readonly HttpClient _httpClient;

    public BingAdapter(string apiKey, ILogger<BingAdapter>? logger = null)
    {
        this._logger = logger ?? NullLogger<BingAdapter>.Instance;
