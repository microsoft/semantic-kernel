...
public interface IWebSearchEngineConnector
{
    ...
    /// <param name="relatedSites">Specific sites to search in.</param>
    ...
    Task<IEnumerable<string>> SearchAsync(string query, List<string> relatedSites, int count = 1, int offset = 0, CancellationToken cancellationToken = default);
}
