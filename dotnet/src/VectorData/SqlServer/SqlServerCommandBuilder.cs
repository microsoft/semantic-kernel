...
internal static class SqlServerCommandBuilder
{
        ...
        CollectionModel model)
    {
        ...
        var fullTextProperties = new List<IDataPropertyModel>();
        foreach (var dataProperty in model.DataProperties)
        {
    ...
    internal static bool Upsert<TKey>(
        ...
        Dictionary<IVectorPropertyModel, IReadOnlyList<Embedding>>? generatedEmbeddings)
    {
    ...
    internal static bool DeleteMany<TKey>(
        ...
        IKeyPropertyModel keyProperty, IEnumerable<TKey> keys)
    {
        StringBuilder sb = new(100);
        sb.Append("DELETE FROM ");
        sb.AppendTableName(schema, tableName);
    ...
    private static StringBuilder AppendIdentifiers(this StringBuilder sb,
        IEnumerable<IPropertyModel> properties,
        string? prefix = null,
    ...
    private static StringBuilder AppendKeyParameterList<TKey>(this StringBuilder sb,
        IEnumerable<TKey> keys, SqlCommand command, IKeyPropertyModel keyProperty, out bool emptyKeys)
    {
        int keyIndex = 0;
