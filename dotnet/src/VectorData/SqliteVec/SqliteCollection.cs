...
#pragma warning restore CA1711 // Identifiers should not have incorrect
{
    ...
    private async Task DoUpsertAsync(IEnumerable<TRecord> records, CancellationToken cancellationToken)
    {
        ...
        Dictionary<IVectorPropertyModel, IReadOnlyList<Embedding<float>>>? generatedEmbeddings = null;
        ...
        for (var i = 0; i < vectorPropertyCount; i++)
        {
            ...
            generatedEmbeddings ??= new Dictionary<IVectorPropertyModel, IReadOnlyList<Embedding<float>>>(vectorPropertyCount);
