...
internal static class SqliteCommandBuilder
{
    ...
    public static DbCommand BuildInsertCommand(
        ...
        Dictionary<IVectorPropertyModel, IReadOnlyList<Embedding<float>>>? generatedEmbeddings,
        bool data,
        bool replaceIfExists = false)
    {
        ...
        var properties = model.KeyProperties.Concat(data ? model.DataProperties : (IEnumerable<IPropertyModel>)model.VectorProperties).ToList();
    ...
    private static StringBuilder AppendColumnNames(this StringBuilder builder, bool includeVectors, IReadOnlyList<IPropertyModel> properties,
