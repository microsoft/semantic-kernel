...
public class SqlServerBasicQueryTests(SqlServerBasicQueryTests.Fixture fixture)
    : BasicQueryTests<int>(fixture), IClassFixture<SqlServerBasicQueryTests.Fixture>
{
