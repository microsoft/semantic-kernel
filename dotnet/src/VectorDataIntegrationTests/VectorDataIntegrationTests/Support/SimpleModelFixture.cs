    ...
    protected override VectorStoreRecordDefinition GetRecordDefinition()
        => new()
        {
            ...
            [
                ...
                new VectorStoreRecordDataProperty(nameof(SimpleRecord<TKey>.Number), typeof(int)) { IsFilterable = true },
                new VectorStoreRecordDataProperty(nameof(SimpleRecord<TKey>.Text), typeof(string)) { IsFilterable = true },
            ]
        };
}
