    ...
    return chat.invokeAsync(context, null)
        .map(
            result -> {
              ...
              StringVariable existingHistoy = finalContext.getVariables()
                  .get("history", StringVariable.class);
              if (existingHistoy == null) {
                existingHistoy = StringVariable.of("");
              }
              existingHistoy = existingHistoy.append(
                  StringVariable.of(
