...
public final class AzureCognitiveSearchMemoryRecord {
  ...
  final static String ADDITIONAL_METADATA = "AdditionalMetadata";
  final static String EMBEDDING = "Embedding";
  final static String EXTERNAL_SOURCE_NAME = "ExternalSourceName";
  final static String IS_REFERENCE = "Reference";
