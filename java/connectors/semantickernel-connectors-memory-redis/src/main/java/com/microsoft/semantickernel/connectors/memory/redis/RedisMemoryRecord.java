...
public class RedisMemoryRecord extends JsonMemoryRecord {
    ...
    public RedisMemoryRecord(String id, String text, String description, String additionalMetadata,
                             List<Float> embedding, String externalSourceName, boolean isReference) {
        super(id, text, description, additionalMetadata, embedding, externalSourceName, isReference);
    }
     ...
     * @param withEmbedding A boolean flag indicating that the embedding should be returned with the metadata
     *
...
//            }
            ...
            throw new RedisException(
                    RedisException.ErrorCodes.REDIS_ERROR,
                    "Error deserializing Redis entry",
                    e);
        }
