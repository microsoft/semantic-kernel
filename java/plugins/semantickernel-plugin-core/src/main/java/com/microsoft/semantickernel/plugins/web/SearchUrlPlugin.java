...
public class SearchUrlPlugin {
    ...
    public String AmazonSearchUrl(@KernelFunctionParameter(description="Text to search for", name="query", required=true, type=String.class) String query)
    {
    ...
    public String BingSearchUrl(@KernelFunctionParameter(description="Text to search for", name="query", required=true, type=String.class) String query)
    {
        String encoded = encode(query);
    ...
    public String BingImagesSearchUrl(@KernelFunctionParameter(description="Text to search for", name="query", required=true, type=String.class) String query)
    {
        String encoded = encode(query);
    ...
    public String BingMapsSearchUrl(@KernelFunctionParameter(description="Text to search for", name="query", required=true, type=String.class) String query)
    {
        String encoded = encode(query);
    ...
    public String BingShoppingSearchUrl(@KernelFunctionParameter(description="Text to search for", name="query", required=true, type=String.class) String query)
    {
        String encoded = encode(query);
    ...
    public String BingNewsSearchUrl(@KernelFunctionParameter(description="Text to search for", name="query", required=true, type=String.class) String query)
    {
        String encoded = encode(query);
    ...
    public String BingTravelSearchUrl(@KernelFunctionParameter(description="Text to search for", name="query", required=true, type=String.class) String query)
    {
        String encoded = encode(query);
    ...
    public String FacebookSearchUrl(@KernelFunctionParameter(description="Text to search for", name="query", required=true, type=String.class) String query)
    {
        String encoded = encode(query);
    ...
    public String GitHubSearchUrl(@KernelFunctionParameter(description="Text to search for", name="query", required=true, type=String.class) String query)
    {
        String encoded = encode(query);
    ...
    public String LinkedInSearchUrl(@KernelFunctionParameter(description="Text to search for", name="query", required=true, type=String.class) String query)
    {
        String encoded = encode(query);
    ...
    public String TwitterSearchUrl(@KernelFunctionParameter(description="Text to search for", name="query", required=true, type=String.class) String query)
    {
        String encoded = encode(query);
    ...
    public String WikipediaSearchUrl(@KernelFunctionParameter(description="Text to search for", name="query", required=true, type=String.class) String query)
    {
        String encoded = encode(query);
