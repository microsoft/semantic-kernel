...
public class Example69_MutableKernelPlugin {
     ...
     * <p>
     * KernelFunction can be added directly to the function collection of the KernelPlugin
     * by using KernelPlugin.getFunctions and putting the corresponding KernelFunction
     */
    public static void main(String[] args) throws NoSuchMethodException {
        ...
        var result = kernel.invokeAsync(kernel.getPlugins().getFunction("Plugin", "dateFunction"), null, String.class).block();
