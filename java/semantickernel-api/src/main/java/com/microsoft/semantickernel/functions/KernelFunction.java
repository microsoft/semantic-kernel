 ...
 * @see com.microsoft.semantickernel.functions
 * @see com.microsoft.semantickernel.plugin
 * @see com.microsoft.semantickernel.functions.annotations
 */
public abstract class KernelFunction<T> implements Buildable {
     ...
     * @see com.microsoft.semantickernel.functions.KernelFunctionFromPrompt
     * @see com.microsoft.semantickernel.functions.KernelFunctionFromMethod
     */
     ...
     *
     * @param <T> The type of the result of the function
     * @see com.microsoft.semantickernel.functions.KernelFunctionFromPrompt.Builder
     */
