...
public @interface KernelFunctionParameter {
    ...
    /**
     * The description of the parameter. The description should be short and concise. The model uses
     * the description to determine what value to pass to the function.
     *
     ...
     * {@link ContextVariableType} to convert the value from a prompt string to the correct argument
     * type. The type defaults to {@link String} if not provided.
     *
