...
public final class AzureCognitiveSearchRecord {
    ...
    public static class Serializer extends StdSerializer<AzureCognitiveSearchRecord> {
        ...
        public Serializer(Class<AzureCognitiveSearchRecord> t) {
            super(t);
        }

        @Override
        public void serialize(
                AzureCognitiveSearchRecord azureCognitiveSearchRecord,
            ...
            jsonGenerator.writeStringField(
                    "Description", azureCognitiveSearchRecord.getDescription());
            jsonGenerator.writeStringField(
                    "AdditionalMetadata", azureCognitiveSearchRecord.getAdditionalMetadata());
            jsonGenerator.writeStringField(
                    "ExternalSourceName", azureCognitiveSearchRecord.getExternalSourceName());
    ...
    public static class Deserializer extends StdDeserializer<AzureCognitiveSearchRecord> {
        ...
        @Override
        public AzureCognitiveSearchRecord deserialize(
            ...
            return new AzureCognitiveSearchRecord(
                    id, text, description, additionalMetadata, externalSourceName, isReference);
        }
    }
