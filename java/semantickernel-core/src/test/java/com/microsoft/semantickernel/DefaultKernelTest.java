...
public class DefaultKernelTest {
        ...
        void contextVariableTest() {
                ...
                CompletionSKContext readOnlySkContext = chat.buildContext(variables, null, null)
                                .setVariable("history", "")
        ...
        void tellAJoke() {
                ...
                CompletionSKFunction function = kernel.importSkill(
                                "FunSkill",
        ...
        public static OpenAIAsyncClient mockCompletionOpenAIAsyncClientMatchers(
                ...
                OpenAIAsyncClient openAIAsyncClient = Mockito
                                .mock(OpenAIAsyncClient.class);
        ...
        void inlineFunctionTest() {
                ...
                CompletionSKFunction summarize = SKBuilders.completionFunctions()
                                .createFunction(
                                                prompt,
                                                "summarize",
                                                null,
