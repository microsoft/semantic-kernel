...
This console application demonstrates the final solution to the [Creating native functions](https://learn.microsoft.com/en-us/semantic-kernel/ai-orchestration/native-functions) doc article.
