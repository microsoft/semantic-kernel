...
# 4) Prompt with simple variable
# A prompt with a simple variable. For example:

# var result = await kernel.InvokePromptAsync<ChatMessageContent>(
#     "Can you help me tell the time in {{$city}} right now?",
#     arguments: new()
#     {
#         city = "Seattle"
#     }
...
# This will validate that each language can substitute a variable in a prompt.
####################################################################################################
...
async def main():
    ...
    print(
        await kernel.invoke_prompt(
            function_name="prompt_test_4",
            plugin_name="test_4",
            prompt="Can you help me tell the time in {{$city}} right now?",
            settings=settings,
