...
# 5) Prompt with complex objects
# [!NOTE] This is not possible with the out-of-the-box Semantic Kernel template engine.

# A prompt with complex objects. For example:
...
# This will validate that each language can substitute a complex object in a prompt.
####################################################################################################
...
async def main():
    ...
    print(
        await kernel.invoke_prompt(
            function_name="prompt_test_5",
            plugin_name="test_5",
            prompt="Can you help me tell the time in {{city.name}} right now?",
            settings=settings,
