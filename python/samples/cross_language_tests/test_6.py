...
# [!NOTE] Today, the delimiter for helper functions is a . for the out-of-the-box Semantic Kernel template
# engine. Out-of-the-box, we should also support the - delimiter for helper functions to align with Handlebars
# and the OpenAI API. The same should also be true for Jinja and future template engines.
...
#     "<message role=\"system\">The current time is {{Time-Now}}</message><message role=\"user\">Can you help me tell the time in {{$city}} right now?</message>", # noqa: E501
#     arguments: new()
#     {
#         city = "Seattle"
#     }
...
async def main():
    ...
    print(
        await kernel.invoke_prompt(
            ...
            plugin_name="test_6",
            prompt='<message role="system">The current time is {{Time.Now}}</message><message role="user">Can you help me tell the time in {{$city}} right now?</message>',  # noqa: E501
            settings=settings,
