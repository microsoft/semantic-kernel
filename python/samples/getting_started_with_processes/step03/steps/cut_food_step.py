...
class CutFoodStep(KernelProcessStep):
    ...
    async def chop_food(self, context: KernelProcessStepContext, food_actions: list[str]):
        ...
        context.emit_event(KernelProcessEvent(id=CutFoodStep.OutputEvents.ChoppingReady.value, data=food_actions))
    ...
    async def slice_food(self, context: KernelProcessStepContext, food_actions: list[str]):
        ...
        context.emit_event(KernelProcessEvent(id=CutFoodStep.OutputEvents.SlicingReady.value, data=food_actions))
