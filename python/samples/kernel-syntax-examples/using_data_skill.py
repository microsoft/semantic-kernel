...
async def main() -> None:
    ...
    print(result)
    """
    Bob is 32 years old and Eve lives in Miami.
    """
    ...
    prompt = "How much does the average salary differ between the two groups?"
    result = await query_async.invoke_async(prompt)
    print(result)
    """
    The average salary difference between the two groups is $2400.
    """
