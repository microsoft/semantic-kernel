...
from semantic_kernel.connectors.ai.open_ai.services.open_ai_response_base import OpenAIResponseBase
...
class OpenAIResponse(OpenAIConfigBase, OpenAIResponseBase):
    """OpenAI Response class."""
    ...
    def __init__(
        ...
        """Initialize an OpenAIResponse service.
    ...
    @classmethod
    def from_dict(cls, settings: dict[str, Any]) -> "OpenAIResponse":
