...
from semantic_kernel.memory.protocols.memory_record_base import MemoryRecordServiceBase
...
@experimental_class
class AzureAISearchMemoryRecordService(MemoryRecordServiceBase[DataModelT, str]):
    ...
    async def get(self, collection_name: str, key: str, with_embedding: bool = False, **kwargs) -> DataModelT:
        ...
        return self._item_type(**search_result)
    ...
    async def get_batch(
        ...
        for key in keys:
            ...
            search_results.append(self._item_type(**search_result))
