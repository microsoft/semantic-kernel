...
from semantic_kernel.connectors.memory.opengauss.opengauss_memory_store import DEFAULT_SCHEMA
...
@experimental
class OpenGaussStore(VectorStore):
    """openGauss store implementation."""
    ...
    def get_collection(
        ...
        **kwargs: Any,
        ...
        if collection_name not in self.vector_record_collections:
            self.vector_record_collections[collection_name] = OpenGaussCollection(
