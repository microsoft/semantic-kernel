...
def pyarrow_table_to_memoryrecords(table: pa.Table, vectors: ndarray | None = None) -> list[MemoryRecord]:
    ...
    Args:
        ...
        vectors (ndarray | None, optional): An array of vectors to include as embeddings in the MemoryRecords.
...
class USearchMemoryStore(MemoryStoreBase):
    def __init__(
        ...
        Args:
            persist_directory (os.PathLike | None, default=None): Directory for loading and saving collections.
    ...
    async def create_collection(
        ...
        Args:
            ...
            metric (str | MetricKind | CompiledMetric, optional): Metric kind. Defaults to MetricKind.IP.
            dtype (str | ScalarKind | None, optional): Data type. Defaults to None.
    ...
    async def upsert_batch(
        ...
        *,
        ...
        Args:
            ...
            log (str | bool, optional): Whether to print the progress bar. Defaults to False.
