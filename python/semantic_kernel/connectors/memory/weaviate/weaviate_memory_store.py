...
class FieldMapper:
    ...
    WEAVIATE_TO_SK_MAPPING: Final[dict[str, str]] = {
        v: k for k, v in SK_TO_WEAVIATE_MAPPING.items()
    }
...
class WeaviateMemoryStore(MemoryStoreBase):
    ...
    def __init__(
        ...
        """
        from semantic_kernel.connectors.memory.weaviate.weaviate_settings import (
            WeaviateSettings,
        )
