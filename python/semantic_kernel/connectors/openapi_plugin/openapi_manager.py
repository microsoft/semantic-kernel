...
def _create_function_from_operation(
    ...
    async def run_openapi_operation(
        path_params: Annotated[dict | str | None, "A dictionary of path parameters. If not specified, return empty string."] = None,
        query_params: Annotated[dict | str | None, "A dictionary of query parameters. If not specified, return empty string."] = None,
        headers: Annotated[dict | str | None,"A dictionary of headers. If not specified, return empty string."] = None,
        request_body: Annotated[dict | str | None, "A dictionary of the request body. If not specified, return empty string."] = None,
    ) -> str:
