...
RESPONSE_MESSAGE_CONTENT_TAG: Final[str] = "response_message"
RESPONSE_FUNCTION_RESULT_CONTENT_TAG: Final[str] = "response_function_result"
...
class ContentTypes(str, Enum):
    ...
    RESPONSE_MESSAGE_CONTENT = RESPONSE_MESSAGE_CONTENT_TAG
    RESPONSE_FUNCTION_RESULT_CONTENT = RESPONSE_FUNCTION_RESULT_CONTENT_TAG
