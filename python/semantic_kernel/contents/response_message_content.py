...
class ResponseMessageContent(ChatMessageContent):
    ...
    content_type: Literal[ContentTypes.RESPONSE_MESSAGE_CONTENT] = Field(
        default=RESPONSE_MESSAGE_CONTENT_TAG, init=False
    )  # type: ignore
    tag: ClassVar[str] = RESPONSE_MESSAGE_CONTENT_TAG
    role: AuthorRole
    name: str | None = None
    ...
    def __init__(  # type: ignore
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            encoding: Optional[str] - The encoding of the text.
            status: Optional[Status] - The status of the response.
            ai_model_id: Optional[str] - The id of the AI model that generated this response.
            metadata: Dict[str, Any] - Any metadata that should be attached to the response.
    ...
    def to_element(self) -> "Element":
        """Convert the ResponseMessageContent to an XML Element.

        Args:
            root_key: str - The key to use for the root of the XML Element.

        Returns:
            Element - The XML Element representing the ResponseMessageContent.
        """
    ...
    def from_element(cls, element: Element) -> "ResponseMessageContent":
        ...
        Args:
            element: Element - The XML Element to create the ResponseMessageContent from.

        Returns:
            ResponseMessageContent - The new instance of ResponseMessageContent or a subclass.
        """
        ...
        for child in element:
            if child.tag not in TAG_CONTENT_MAP:
                logger.warning('Unknown tag "%s" in ResponseMessageContent, treating as text', child.tag)
    ...
    def to_prompt(self) -> str:
        """Convert the ResponseMessageContent to a prompt.

        Returns:
            str - The prompt from the ResponseMessageContent.
        """
    ...
    def to_dict(self, role_key: str = "role", content_key: str = "content") -> dict[str, Any]:
        """Serialize the ResponseMessageContent to a dictionary.

        Returns:
            dict - The dictionary representing the ResponseMessageContent.
        """
        ret: dict[str, Any] = {
    ...
    def _parse_items(self) -> str | list[dict[str, Any]]:
        """Parse the items of the ResponseMessageContent.
    ...
    def __hash__(self) -> int:
        ...
        return hash((self.tag, self.role, self.content, self.encoding, self.status, *hashable_items))
