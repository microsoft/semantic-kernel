...
class VectorStoreRecordDataField(VectorStoreRecordField):
    ...
    When using a vector store that supports managed embeddings, you can set the has_embedding to True and
    has_local_embedding to False to indicate this.

    Args:
        property_type: The type of the field.
        has_embedding: Whether the field has a embedding field.
        has_local_embedding: Whether the field has a local embedding field.
        embedding_property_name: The name of the embedding field.
        is_indexed: Whether the field is indexed.
        is_full_text_indexed: Whether the field is full text indexed.
    """

    has_embedding: bool = False
    has_local_embedding: bool = True
