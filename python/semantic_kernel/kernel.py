...
class Kernel(KernelBase, KernelExtensions):
    ...
    def set_default_text_service(self, service_id: str) -> "Kernel":
    ...
    def set_default_embedding_service(self, service_id: str) -> "Kernel":
    ...
    def remove_text_service(self, service_id: str) -> "Kernel":
        if service_id not in self._text_services:
            raise ValueError(
                f"AI service with service_id '{service_id}' does not exist"
            )
    ...
    def remove_embedding_service(self, service_id: str) -> "Kernel":
        if service_id not in self._embedding_services:
            raise ValueError(
                f"AI service with service_id '{service_id}' does not exist"
            )
    ...
    def clear_all_text_services(self) -> "Kernel":
        self._text_services = {}
    ...
    def clear_all_embedding_services(self) -> "Kernel":
