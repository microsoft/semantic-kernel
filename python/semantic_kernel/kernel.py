    ...
    def _create_semantic_function(
        ...
        if function_config.has_chat_prompt:
            ...
            function.set_chat_configuration(
                req_settings_type.from_ai_request(function_config.prompt_template_config.completion)
            )
            ...
            function.set_ai_configuration(
                req_settings_typefrom_ai_request_settings(function_config.prompt_template_config.completion)
            )
