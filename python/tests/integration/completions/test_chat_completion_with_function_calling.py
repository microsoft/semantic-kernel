...
pytestmark = pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            {"test_type": FunctionChoiceTestTypes.NON_AUTO},
            id="bedrock_ai21labs_tool_call_non_auto",
        ),
        pytest.param(
            "bedrock_ai21labs",
            {
            ...
            {"test_type": FunctionChoiceTestTypes.FLOW},
            id="bedrock_ai21labs_tool_call_flow",
        ),
        pytest.param(
            "bedrock_ai21labs",
            {
            ...
            {"test_type": FunctionChoiceTestTypes.AUTO},
            id="bedrock_ai21labs_tool_call_auto_complex_return_type",
        ),
        # endregion
        # region Bedrock Meta Llama
        pytest.param(
            "bedrock_meta_llama",
            {
                "function_choice_behavior": FunctionChoiceBehavior.Auto(
            ...
            {"test_type": FunctionChoiceTestTypes.NON_AUTO},
            id="bedrock_meta_llama_tool_call_non_auto",
        ),
        pytest.param(
            "bedrock_meta_llama",
            {
            ...
            {"test_type": FunctionChoiceTestTypes.FLOW},
            id="bedrock_meta_llama_tool_call_flow",
        ),
        pytest.param(
            "bedrock_meta_llama",
            {
            ...
            {"test_type": FunctionChoiceTestTypes.AUTO},
            id="bedrock_meta_llama_tool_call_auto_complex_return_type",
        ),
        # endregion
    ],
)
