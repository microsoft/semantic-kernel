...
@fixture()
def exa_unit_test_env(monkeypatch, exclude_list, override_env_param_dict):
    """Fixture to set environment variables for ExaConnector."""
    if exclude_list is None:
        exclude_list = []
    ...
    env_vars = {"EXA_API_KEY": "test_api_key"}
