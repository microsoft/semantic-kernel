...
def test_can_be_imported():
    ...
    assert kernel.get_plugin("math") is not None
    assert kernel.get_plugin("math").name == "math"
    assert kernel.get_function("math", "Add") is not None
    assert kernel.get_function("math", "Subtract") is not None
