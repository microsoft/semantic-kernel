...
from semantic_kernel.memory import QdrantMemoryStore
...
async def test_cosine_similarity_valid():
    ...
    scores = qdrant_memory_store.compute_similarity_scores(
...
async def test_cosine_similarity_zero_query():
    ...
    with raises(ValueError):
        _ = qdrant_memory_store.compute_similarity_scores(
