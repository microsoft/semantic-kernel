...
def test_merged_context_vars_with_empty_input_results_in_empty_input():
    ...
    assert context_vars_combined_1with2._variables["test_string"] == variables["test_string"]
    ...
    assert context_vars_combined_2with1._variables["test_string"] == variables["test_string"]
...
def test_merged_context_vars_with_different_input_results_in_input_overwrite1():
    ...
    assert context_vars_combined_1with2._variables is not None
    assert len(context_vars_combined_1with2._variables) == 2
    assert context_vars_combined_1with2._variables["input"] == context_vars2._variables["input"]
    assert context_vars_combined_1with2._variables["test_string"] == context_vars2._variables["test_string"]
...
def test_merged_context_vars_with_different_input_results_in_input_overwrite2():
    ...
    assert context_vars_combined_2with1._variables["test_string"] == context_vars2._variables["test_string"]
...
def test_can_overwrite_context_variables1():
    ...
    assert len(context_vars_overwrite_1with2._variables) == len(context_vars2._variables)
    assert context_vars_overwrite_1with2._variables["input"] == context_vars2._variables["input"]
    assert context_vars_overwrite_1with2._variables["test_string"] == context_vars2["test_string"]
...
def test_can_overwrite_context_variables2():
    ...
    assert len(context_vars_overwrite_2with1._variables) == len(context_vars1._variables)
    assert context_vars_overwrite_2with1._variables["input"] == context_vars1._variables["input"]
