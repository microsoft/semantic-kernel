...
namespace SemanticKernel.CopilotChat.Controllers;
...
public class BotController : ControllerBase
{
    ...
    private readonly CopilotChatAIServiceOptions _embeddingOptions;
    ...
    public BotController(
        ...
        IOptionsSnapshot<CopilotChatAIServiceOptions> aiServiceOptions,
        ...
        ILogger<BotController> logger)
    {
        ...
        this._embeddingOptions = aiServiceOptions.Get(CopilotChatAIServiceOptions.EmbeddingPropertyName);
    ...
    private static bool IsBotCompatible(
        ...
        CopilotChatAIServiceOptions embeddingOptions,
