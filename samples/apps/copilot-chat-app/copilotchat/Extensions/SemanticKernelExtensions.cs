...
namespace SemanticKernel.CopilotChat.Extensions;
...
public static class CopilotChatSemanticKernelExtensions
{
    ...
    /// </summary>
    private static KernelConfig AddPlannerBackend(this KernelConfig kernelConfig, CopilotChatAIServiceOptions options)
    {
        switch (options.AIService)
        {
            case CopilotChatAIServiceOptions.AIServiceType.AzureOpenAI:
            ...
            case CopilotChatAIServiceOptions.AIServiceType.OpenAI:
            ...
            default:
                throw new ArgumentException($"Invalid {nameof(options.AIService)} value in '{CopilotChatAIServiceOptions.CompletionPropertyName}' settings.");
        }
