...
export function convertToAnchorTags(htmlString: string) {
    // Regular expression to match links, exluding any HTML tags at the end
    // Since response from bot is plain text, sometimes line breaks and other html tags are included in the response for readibility.
