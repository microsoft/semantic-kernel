...
";
    ...
    {
        if (!context.Variables.TryGet(RepositoryBranchParamName, out string repositoryBranch) || string.IsNullOrEmpty(repositoryBranch))
        {
            repositoryBranch = "main";
        }

        if (!context.Variables.TryGet(SearchPatternParamName, out string searchPattern) || string.IsNullOrEmpty(searchPattern))
        {
            searchPattern = "*.md";
        }
