...
public static class Example14_Memory
{
    ...
    {
        const string MEMORY_COLLECTION_NAME = "SKGitHub";
        ...
        */
        ...
        var memories = kernel.Memory.SearchAsync(MEMORY_COLLECTION_NAME, ask, limit: 5, minRelevanceScore: 0.77);
        ...
        */
        ...
        memories = kernel.Memory.SearchAsync(MEMORY_COLLECTION_NAME, ask, limit: 5, minRelevanceScore: 0.77);
