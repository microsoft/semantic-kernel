...
export class VectorOperations {
     ...
     */
    public static cosineSimilarity(x: readonly number[], y: readonly number[]): number {
     ...
     *
     * @param x The vector.
     * @returns Euclidean length as a double.
     */
    public static euclideanLength(x: number[] | readonly number[]): number {
