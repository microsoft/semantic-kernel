...
export class FunctionsView {
     ...
     */
    public semanticFunctions: CaseInsensitiveMap<string, FunctionView[]> = new CaseInsensitiveMap();

    /**
     * Collection of native skill names and function views, including function parameters.
     * Functions are grouped by skill name.
     */
    public nativeFunctions: CaseInsensitiveMap<string, FunctionView[]> = new CaseInsensitiveMap();
     ...
     */
    public addFunction(view: FunctionView): FunctionsView {
        if (view.isSemantic) {
